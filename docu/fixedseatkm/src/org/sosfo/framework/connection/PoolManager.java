...
public class PoolManager {
	...
	try {
	    System.out.println("driver test ==== " + conf.getString(conName + ".driver"));
		...
		System.out.println(conf.getString(conName+".user"));
		System.out.println(conf.getString(conName + ".password"));
