package snis.boa.equipment.e06010150.activity;
...
public class SavePropellerMaintenanceNew extends SnisActivity
{
  ...
  protected int mergePropellerMaintenance(PosRecord record)
  {
    ...
    return getDao("boadao").update("tbef_propeller_maintenance_new_mf001", param);
  }
  ...
  protected int deletePropellerMaintenance(PosRecord record)
  {
    ...
    int i = 0;
    param.setValueParamter(i++, record.getAttribute("MAINTENANCE_SEQ"));
    return getDao("boadao").update("tbef_propeller_maintenance_new_df001", param);
  }
