/*================================================================================
 * 시스템			: 심판관리   
 * 소스파일 이름	: snis.boa.referere.e04110020.activity.SearchStatTime2.java
...
public class SearchStatTime2 extends SnisActivity {
    ...
    protected void SearchStatTimeSum(PosContext ctx) 
    {
    	StringBuffer sbQuery = new StringBuffer();
    	  ...
    	  sbQuery.append("\n                           ,B.VOIL_CD     VOIL_CD ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=0   AND NVL(A.STAR_TM,0) <=0.09 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT1 ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=0.1 AND NVL(A.STAR_TM,0) <=0.19 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT2 ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=0.2 AND NVL(A.STAR_TM,0) <=0.29 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT3 ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=0.3 AND NVL(A.STAR_TM,0) <=0.39 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT4 ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=0.4 AND NVL(A.STAR_TM,0) <=0.49 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT5 ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=0.5 AND NVL(A.STAR_TM,0) <=0.99 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT6 ");
    	  sbQuery.append("\n                           ,CASE WHEN A.ST_MTHD_CD != '001' AND NVL(A.STAR_TM,0) >=1.0 AND NVL(A.STAR_TM,0) <=1.50 AND (A.STAR_TM IS NOT NULL ) THEN STAR_TM ELSE 0  END  COUNT7 ");
    	  sbQuery.append("\n                   FROM     TBEB_ORGAN A, ");
    	  sbQuery.append("\n							( SELECT * ");
