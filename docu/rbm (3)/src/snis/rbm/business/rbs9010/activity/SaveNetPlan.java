...
public class SaveNetPlan extends SnisActivity {
    ...
    */
     ...
     * @throws  none
     */
    protected int saveNetPlan(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, record.getAttribute("NET_SALES_AMT"));	// 순매출목표
