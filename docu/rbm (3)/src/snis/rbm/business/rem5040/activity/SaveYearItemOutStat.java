...
public class SaveYearItemOutStat extends SnisActivity {
	
	public SaveYearItemOutStat(){
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        if ( ctx.get(sDsName) != null ) {
	        ...
	        */
			nSaveCount += updateUnGoodStorStat(brncCd, sUnStorDt, StatCd, sAprvId);
        }
    ...
    {	
        ...
        //param.setValueParamter(i++, record.getAttribute("YEAR_ITEM_SEQ_NO"));			//연번
        param.setValueParamter(i++, UnStorDt);								//출고일자
        
        int dmlcount = this.getDao("rbmdao").update("rem5040_u03", param);
