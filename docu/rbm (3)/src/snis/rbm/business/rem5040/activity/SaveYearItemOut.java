...
public class SaveYearItemOut extends SnisActivity {
    ...
    */
    ...
    protected boolean CheckBalance(PosRecord record) 
    {
        ...
        param.setWhereClauseParameter(i++, record.getAttribute("YEAR_ITEM_SEQ_NO" ));	//단가계약상품연번
        ...
        if (nUnstorCntCum < nUnstorCntThis) {	// 남아 있는 수량 보다 출고/폐기 수량이 넘은 경우
        	return false;
        }
        return true;
    }
