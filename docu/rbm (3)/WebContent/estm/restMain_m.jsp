...
<script>
	function makeReg(rstId, rstSeq) {
		if(confirm("등록하시겠습니까?")) {
			document.location.href = "restRegister.jsp?rsvYear=<%=strRsvYear%>&rsvTms=<%=strRsvTms%>&rstId="+rstId+"&rstSeq="+rstSeq+"&mobile=Y";
		}
	...
	function deleteReg() {
		if(confirm("삭제하시겠습니까?")) {
			document.location.href = "restDelete.jsp?rsvYear=<%=strRsvYear%>&rsvTms=<%=strRsvTms%>"+"&mobile=Y";
		}
	}
	...
	<tr>
		<td width="100%">
			<table class='list'>
				...
				<tr>
					<td colspan=3>
					<a href="javascript:goLink('01');"><img id="idVect01" src="./img/BlessOcean.png" width="227" height="70" alt="블레스오션펜션"></a>
					<br>신청이나 변경은 숙박기간을 클릭하시면 됩니다.<br> 취소시에는 본인 이름을 클릭하세요.
					</td>
				</tr>
				
				<tr>
					<th class="right_b blue" width="100"  align=center>숙박<br>기간</th>
					<th class="right_b blue" width="50"  align=center>수용<br>인원</th>
					<th class="right_b blue" width="330" align=center>신청<br>인원</th>
