...
<head>
	...
	$(function() {
		...
		$("#meet_nm").html("&nbsp;&nbsp;미사리(판매금액)&nbsp;&nbsp;").css({top: 15, left:$(window).width()/2});
...
<body width="100%">
	<div width="100%" id="content">
		<div width="100%" class="mra-container">
			<div id="placeholder" class="mra-placeholder"></div>
		</div>
	</div>
</body>
</html>
