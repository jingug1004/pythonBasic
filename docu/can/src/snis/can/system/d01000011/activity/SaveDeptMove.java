package snis.can.system.d01000011.activity;
...
public class SaveDeptMove extends SnisActivity {
    ...
    */
    ...
    protected int updateAuthAplyDept(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("d01000011_u01", param);
        //rsy3040_u01
        return dmlcount;
    }
    ...
    protected int deleteAuthAplyDept(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("d01000011_d02", param);
        //rsy3040_d02
