/*================================================================================
 * 시스템			: 게시판 관리
 * 소스파일 이름	: snis.can.system.d01000005.activity.BoardManager.java
 * 파일설명		: 게시판 관리
 * 작성자			: 박연자
 * 버전			: 1.0.0
 * 생성일자		: 2007-11-25
 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can.system.d01000005.activity;
...
{    
    ...
    */
    ...
    protected int replyBoard(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, SESSION_USER_ID);
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("candao").update("tbda_bord_ia003", param);
    ...
    protected int updateBoard(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_bord_ua001", param);
    ...
    protected int deleteBoard(PosContext ctx)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_bord_da001", param);
        return dmlcount;
    }
