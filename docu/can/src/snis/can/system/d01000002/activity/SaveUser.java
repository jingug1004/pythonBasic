/*================================================================================
 * 시스템			: User 관리
 * 소스파일 이름	: snis.can.system.d01010030.activity.UserManager.java
 * 파일설명		: User 관리
 * 작성자			: 박연자
 * 버전			: 1.0.0
 * 생성일자		: 2007-12-05
 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can.system.d01000002.activity;
...
{    
    ...
    */
	         ...
	         for ( int i = 0; i < nSize; i++ ) {
	           PosRecord record = ds.getRecord(i);
	               ...
	               || record.getType() == com.posdata.glue.miplatform.vo.PosRecord.INSERT )
	             {
	            	 ...
	            	 int p = 0;
	            	 param.setWhereClauseParameter(p++, record.getAttribute("USER_ID"));
	            	 PosRowSet rlt = this.getDao("candao").find("tbda_user_fa002",param);
	            	 if(rlt.count()<= 0) {
    ...
    protected int updateUser(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_user_ua001", param);
    ...
    protected int insertUser(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_user_ia001", param);
    ...
    protected int deleteUser(PosRecord record) 
    {
        ...
        int dmlcount  = this.getDao("candao").update("tbda_user_da001", param);
        	dmlcount += this.getDao("candao").update("tbda_mn_auth_da001", param);
