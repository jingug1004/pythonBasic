/*================================================================================
 * 시스템			: 코드 관리
 * 소스파일 이름	: snis.can.system.e01010030.activity.UserManager.java
 * 파일설명		: 코드 관리
 * 작성자			: 김영철
 * 버전			: 1.0.0
 * 생성일자		: 2007-12-07
 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can.system.d01000001.activity;
...
{    
    ...
    */
    ...
    protected int insertGrpCode(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_grp_cd_ia001", param);
    ...
    protected int updateGrpCode(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_grp_cd_ua001", param);
        return dmlcount;
    }
    ...
    protected int deleteGrpCode(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_grp_cd_da001", param);
        ...
        dmlcount = dmlcount + this.getDao("candao").update("tbda_spec_cd_da001", param1);
        return dmlcount;
    }
    ...
    protected int insertSpecCode(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_spec_cd_ia001", param);
    ...
    protected int updateSpecCode(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_spec_cd_ua001", param);
    ...
    protected int deleteSpecCode(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbda_spec_cd_da001", param);
