package snis.can.system.d01000008.activity;
...
public class SaveMenuAuth extends SnisActivity {
    ...
    */
    ...
    protected int updateAuthMenu(String MenuID, String curDtm, PosRecord record) 
    {
 		...
 		rowset = this.getDao("candao").find("d01000008_s04", param);
 		...
 		if (bAuthExist == false && bAuthSet == true) {
	        ...
	        param.setValueParamter(i++, sSrchYn);
 	        ...
 	        dmlcount += this.getDao("candao").update("d01000008_i02", param);
 	       ...
 	       perparam.setValueParamter(i++, sPerMnIp); 
 	        ...
 	        dPercount += this.getDao("candao").update("d01000008_i03", perparam);
 	    // 3)자료가 있으면
	        ...
	        dmlcount += this.getDao("candao").update("d01000008_u02", param);
