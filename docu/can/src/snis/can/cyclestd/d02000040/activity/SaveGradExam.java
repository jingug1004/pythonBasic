 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can.cyclestd.d02000040.activity;
...
public class SaveGradExam extends SnisActivity 
{
	public SaveGradExam() { }
    ...
    protected int insertSavePerioExam1(PosRecord record) 
    {
     ...
     if(!sRec200.equals("")){
		...
		param.setValueParamter(i++, SESSION_USER_ID);
			...
			dmlcount += this.getDao("candao").insert("tbdb_period_exam_ib001", param);
     }
