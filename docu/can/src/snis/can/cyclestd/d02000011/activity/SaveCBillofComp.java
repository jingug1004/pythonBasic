...
{    
    ...
    */
    ...
    protected int insertBlng_Cert(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdb_blng_cert_ib001", param);
    ...
    protected int updateBlng_Cert(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdb_blng_cert_ub001", param);
    ...
    protected int deleteBlng_Cert(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdb_blng_cert_db001", param);
