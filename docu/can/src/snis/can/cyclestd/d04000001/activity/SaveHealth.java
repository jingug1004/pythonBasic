 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can.cyclestd.d04000001.activity;
       ...
       */
        ...
        */
        ...
        protected int insertHealth(PosRecord record) 
        {
            ...
            int dmlcount = this.getDao("candao").insert("tbdd_health_ib001", param);
        ...
        protected int updateHealth(PosRecord record) 
        {
            ...
            param.setWhereClauseParameter(i++, record.getAttribute("SEQ"));
	   		...
	   		int dmlcount = this.getDao("candao").update("tbdd_health_ub001", param);
        ...
        protected int deleteHealth(PosRecord record) 
        {
            ...
            int dmlcount = this.getDao("candao").delete("tbdd_health_db001", param);
        ...
        protected int insertWound1(PosRecord record) 
        {
        	...
        	if (record.getAttribute("BODY_YN1".trim()) != null) {
	            ...
	            param.setValueParamter(i++, SESSION_USER_ID);
	            dmlcount += this.getDao("candao").insert("tbdd_wound_ib001", param);
        	}
        ...
        protected int updateWound1(PosRecord record) 
        {
        	...
        	if (record.getAttribute("BODY_YN1".trim()) != null) {
	            ...
	            dmlcount += this.getDao("candao").update("tbdd_wound_ub001", param);
        	}
          	logger.logInfo("WJDDMLXO7============================");
          	if (record.getAttribute("BODY_YN2".trim()) != null) {
				i = 0;
				param = new PosParameter();
	            param.setValueParamter(i++, record.getAttribute("BODY_YN2"));
        ...
        protected int insertWound2(PosRecord record) 
        {
            ...
            int dmlcount = this.getDao("candao").insert("tbdd_wound_ib002", param);
        ...
        protected int updateWound2(PosRecord record) 
        {
            ...
            param.setWhereClauseParameter(i++, record.getAttribute("BODY_PART"));
	   		...
	   		int dmlcount = this.getDao("candao").update("tbdd_wound_ub002", param);
        ...
        protected int deleteWound(PosRecord record) 
        {
            ...
            int dmlcount = this.getDao("candao").delete("tbdd_wound_db001", param);
        ...
        protected int insertExtExam(PosRecord record) 
        {
            ...
            int dmlcount = this.getDao("candao").insert("tbdd_ext_exam_ib001", param);
        ...
        protected int updateExtExam(PosRecord record) 
        {
	        ...
	        param.setWhereClauseParameter(i++, record.getAttribute("SEQ"));
	   		...
	   		int dmlcount = this.getDao("candao").update("tbdd_ext_exam_ub001", param);
        ...
        protected int deleteExtExam(PosRecord record) 
        {
            ...
            int dmlcount = this.getDao("candao").delete("tbdd_ext_exam_db001", param);
