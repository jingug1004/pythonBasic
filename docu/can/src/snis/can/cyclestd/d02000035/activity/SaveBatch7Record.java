...
* @version 1.0
*/
public class SaveBatch7Record extends SnisActivity
{    
    public SaveBatch7Record()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        for ( int i = 0; i < nSize; i++ ){
        	...
        	PosRecord record = ds.getRecord(i);
           	nSaveCount = nSaveCount + SaveBatch7(record);
        }
    ...
    /**
     * <p> 선두유도횟수 집계자료 Save </p>
     * @param   record	 PosRecord	데이타셋에 대한 하나의 레코드
     * @return  dmlcount int		update 레코드 개수
     * @throws  none
     */
    protected int SaveBatch7(PosRecord record)
    {
    ...
    protected int updateTbdbRecTot(PosRecord record)
    {
        ...
        param.setValueParamter(i++, record.getAttribute("ROUND_FROM")); 
        param.setValueParamter(i++, record.getAttribute("ROUND_TO"));
        return  this.getDao("candao").update("tbdb_rec_tot_ub006", param); 
