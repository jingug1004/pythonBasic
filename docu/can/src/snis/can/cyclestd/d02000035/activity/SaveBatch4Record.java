...
* @version 1.0
*/
public class SaveBatch4Record extends SnisActivity
{    
    public SaveBatch4Record()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        for ( int i = 0; i < nSize; i++ ){
        	...
        	PosRecord record = ds.getRecord(i);
           	nSaveCount = nSaveCount + SaveBatch4(record);
        }
    ...
    /**
     * <p> 승률/연대율 집계자료 Save </p>
     * @param   record	 PosRecord	데이타셋에 대한 하나의 레코드
     * @return  dmlcount int		update 레코드 개수
     * @throws  none
     */
    protected int SaveBatch4(PosRecord record)
    {
    ...
    protected int updateTbdbRecTot(PosRecord record)
    {
        ...
        return  this.getDao("candao").update("tbdb_rec_tot_ub003", param); 
