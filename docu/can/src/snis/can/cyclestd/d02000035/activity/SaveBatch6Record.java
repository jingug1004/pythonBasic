...
* @version 1.0
*/
public class SaveBatch6Record extends SnisActivity
{    
    public SaveBatch6Record()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        for ( int i = 0; i < nSize; i++ ){
        	...
        	PosRecord record = ds.getRecord(i);
           	nSaveCount = nSaveCount + SaveBatch6(record);
        }
     ...
     * @throws  none
     */
    protected int SaveBatch6(PosRecord record)
    {
    ...
    protected int updateTbdbRecTot(PosRecord record)
    {
        ...
        param.setValueParamter(i++, record.getAttribute("ROUND_FROM")); 
        param.setValueParamter(i++, record.getAttribute("ROUND_TO"));
        return  this.getDao("candao").update("tbdb_rec_tot_ub005", param); 
