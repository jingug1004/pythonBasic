...
* @version 1.0
*/
public class SaveBatch3Record extends SnisActivity
{    
    public SaveBatch3Record()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        for ( int i = 0; i < nSize; i++ ){
        	...
        	PosRecord record = ds.getRecord(i);
           	nSaveCount = nSaveCount + SaveBatch3(record);
        }
     ...
     * @throws  none
     */
    protected int SaveBatch3(PosRecord record)
    {
    ...
    protected int updateTbdbRecTot(PosRecord record)
    {
        ...
        return  this.getDao("candao").update("tbdb_rec_tot_ub002", param); 
