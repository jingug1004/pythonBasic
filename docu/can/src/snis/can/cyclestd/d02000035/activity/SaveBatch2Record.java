/*================================================================================
 * 시스템			: 편성 관리 
 * 소스파일 이름	: snis.can.cyclestd.d02000035.activity.SaveBatch2Record.java
 * 파일설명		: 종합집계
 * 작성자			: 정의태 
 * 버전			: 1.0.0
 * 생성일자		: 2008-03-19
...
* @version 1.0
*/
public class SaveBatch2Record extends SnisActivity
{    
    public SaveBatch2Record()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        for ( int i = 0; i < nSize; i++ ){
        	...
        	PosRecord record = ds.getRecord(i);
           	nSaveCount = nSaveCount + SaveBatch2(record);
        }
     ...
     * @throws  none
     */
    protected int SaveBatch2(PosRecord record)
    {
    ...
    protected int updateTbdbRecTot(PosRecord record)
    {
        ...
        return  this.getDao("candao").update("tbdb_rec_tot_ub001", param); 
