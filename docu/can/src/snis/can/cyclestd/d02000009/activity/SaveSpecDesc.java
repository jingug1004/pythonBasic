/*================================================================================
 * 시스템			: 후보생 특이사항 관리
 * 소스파일 이름	: snis.can.system.d02000009.activity.SaveSpecDesc.java
 * 파일설명		: 후보생 특이사항 관리
 * 작성자			: 노인수
 * 버전			: 1.0.0
 * 생성일자		: 2008-02-28
...
* 매핑하여 후보생 특이사항 내역을 저장(입력/수정)및 삭제하는 클래스이다.
* @auther 노인수
* @version 1.0
*/
