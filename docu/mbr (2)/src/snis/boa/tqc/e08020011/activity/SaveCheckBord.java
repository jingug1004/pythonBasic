/*================================================================================
 * 시스템			: 내부심사자료
 * 소스파일 이름	: snis.boa.tqc.e08020011.activity.SaveIsoBord.java
 * 파일설명		: 게시판 관리
 * 작성자			: 전홍조
 * 버전			: 1.0.0
 * 생성일자		: 2008-10-10
...
package snis.boa.tqc.e08020011.activity;
...
public class SaveCheckBord extends SnisActivity{

	protected String sStndYear = "";
    public SaveCheckBord()
    {
     ...
     */
     ...
     protected int updateBoard(PosRecord record)
     {
         ...
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_ua002", param);
     ...
     protected int insertBoard(PosRecord record) 
     {
         ...
         param.setValueParamter(i++, SESSION_USER_ID);
         param.setValueParamter(i++, SESSION_USER_ID);
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_ia001", param);
     ...
     protected int replyBoard(PosRecord record, PosContext ctx) 
     {
         ...
         param.setValueParamter(i++, SESSION_USER_ID);
         param.setValueParamter(i++, SESSION_USER_ID);
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_ra001", param);
     ...
     protected int deleteBoard(PosContext ctx)
     {
         ...
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_da001", param);
         return dmlcount;
     }
     ...
     protected int insertFile(PosRecord record, PosContext ctx) 
     {
         ...
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_ia003", param);
     ...
     protected int insertFileWithSeq(PosRecord record, PosContext ctx) 
     {
         ...
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_ia004", param);
     ...
     protected int deleteFile(PosRecord record,  PosContext ctx) 
     {
         ...
         int dmlcount = this.getDao("boadao").update("tbtq_checkbord_da002", param);
