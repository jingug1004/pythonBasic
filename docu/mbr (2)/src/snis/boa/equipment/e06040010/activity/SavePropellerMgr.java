package snis.boa.equipment.e06040010.activity;
...
public class SavePropellerMgr extends SnisActivity
{
    ...
    protected void processRegPropeller(PosRecord record){
	    ...
	    if(!Util.isNull(record.getAttribute("PROVIDE_PROPELLER_NO"))){
		    PosParameter param = new PosParameter();
		        ...
		        getDao("boadao").update("tbef_propeller_mgr_uf001", param);
	    }
    }
    ...
    protected int mergePropellerMgr(PosRecord record)
    {
        ...
        return getDao("boadao").update("tbef_propeller_mgr_mf001", param);
    }
    ...
    protected int deletePropellerMgr(PosRecord record)
    {
        ...
        int i = 0;
        param.setValueParamter(i++, record.getAttribute("PROPELLER_SEQ"));
        return getDao("boadao").update("tbef_propeller_mgr_df001", param);
    }
    ...
    protected int deletePropellerMaintenance(PosRecord record)
    {
        ...
        int i = 0;
        param.setValueParamter(i++, record.getAttribute("PROPELLER_SEQ"));
        return getDao("boadao").update("tbef_propeller_maintenance_df002", param);
    }
}