 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.boa.system.e01010030.activity;
...
{    
    ...
    */
	        ...
	        nSize 		 = ds.getRecordCount();
	         ...
	         for ( int i = 0; i < nSize; i++ ) {
		        ...
		        if ( record.getType() == com.posdata.glue.miplatform.vo.PosRecord.UPDATE ) {
		        	 nTempCnt = updateGrpMenu(record);
		        }
		        
		        if ( record.getType() == com.posdata.glue.miplatform.vo.PosRecord.INSERT ) {
		        	nTempCnt = updateGrpMenu(record);
		        	
		        	if(nTempCnt == 0) insertGrpMenu(record);
		        }
	        ...
	        nSize 		 = ds.getRecordCount();
	         ...
	         for ( int i = 0; i < nSize; i++ ) {
		        ...
		        if ( record.getType() == com.posdata.glue.miplatform.vo.PosRecord.INSERT ) {
		        	...
		        	if(nTempCnt == 0) insertMenu(record);
		        }
    ...
    protected int updateMenu(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbea_mn_ua001", param);
     ...
     * @throws  none
     */
    protected int updateGrpMenu(PosRecord record)
    {
    	logger.logInfo("updateMenu ============================");
        PosParameter param = new PosParameter();
        int i = 0;
    ...
    protected int insertMenu(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, SESSION_USER_ID);
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("boadao").update("tbea_mn_ia001", param);
     ...
     * @throws  none
     */
    protected int insertGrpMenu(PosRecord record) 
    {
    	logger.logInfo("insertGrpMenu ============================");
        PosParameter param = new PosParameter();       					
        int i = 0;
        param.setValueParamter(i++, record.getAttribute("MN_ID"));
        param.setValueParamter(i++, record.getAttribute("MN_NM"));
        param.setValueParamter(i++, SESSION_USER_ID);
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("boadao").update("tbea_mn_ia002", param);
    ...
    protected int deleteMenu(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbea_mn_da001", param);
        return dmlcount;
    }
    ...
    protected int deleteAuthMenu(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbea_mn_da002", param);
        return dmlcount;
    }    
}
