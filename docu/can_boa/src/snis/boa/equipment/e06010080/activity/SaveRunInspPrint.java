...
* @version 1.0
*/
public class SaveRunInspPrint extends SnisActivity
{    
    public SaveRunInspPrint()
    {
    }
    ...
    protected int mergeRunInspPrint(PosRecord record)
    {
        ...
        param.setValueParamter(i++, record.getAttribute("BEFORE_INSP_PRINT_YN"));   
    	param.setValueParamter(i++, record.getAttribute("INSP_PRINT_YN"));  
        param.setValueParamter(i++, SESSION_USER_ID);
            
        return this.getDao("boadao").update("tbef_run_insp_print_mf002", param);
    }
