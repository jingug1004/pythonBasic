...
{    
    ...
    private void getParts(PosContext ctx)
    {
        ...
        rowset = getPartsRowSet( stnd_year, parts_cd, parts_item_cd_nm, mbr_cd, partsComCd);
    ...
    public PosRowSet getPartsRowSet(String stnd_year, String parts_cd, String parts_item_cd_nm, String mbr_cd,String partsComCd)
    {
        ...
        return  this.getDao("boadao").find("tbef_parts_ff001", param);
    }
