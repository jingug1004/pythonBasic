 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can_boa.system.d01000006.activity;
...
{    
    ...
    */
    ...
    protected int insertBoard(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("boadao").update("tbdm_bord_ia001", param);
    ...
    protected void updateGrpLowNo(String grpNo, int grpLowNo) 
    {
        ...
        this.getDao("boadao").update("tbdm_bord_ia002", param);
    }   
    ...
    protected int replyBoard(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, SESSION_USER_ID);
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("boadao").update("tbdm_bord_ia003", param);
    ...
    protected int updateBoard(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbdm_bord_ua001", param);
    ...
    protected int deleteBoard(PosContext ctx)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbdm_bord_da001", param);
        return dmlcount;
    }
