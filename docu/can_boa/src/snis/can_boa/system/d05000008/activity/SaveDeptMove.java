package snis.can_boa.system.d05000008.activity;
...
public class SaveDeptMove extends SnisActivity {
    ...
    */
    ...
    protected int updateAuthAplyDept(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdm_auth_aply_dept_ua001", param);
        return dmlcount;
    }
    ...
    protected int deleteMnAuth(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdm_auth_aply_dept_da001", param);
        return dmlcount;
    }
    ...
    protected int deleteAuthAplyDept(PosRecord record) 
    {
        ...
        int i = 0;
        param.setValueParamter(i++, record.getAttribute("USER_ID") );	
        int dmlcount = this.getDao("candao").update("tbdm_auth_aply_dept_da002", param);
        return dmlcount;
    }
