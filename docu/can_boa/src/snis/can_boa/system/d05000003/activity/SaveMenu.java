/*================================================================================
 * 시스템			: 메뉴 관리
 * 소스파일 이름	: snis.can.system.d05000003.activity.MenuManager.java
 * 파일설명		: 메뉴 관리
 * 작성자			: 박연자
 * 버전			: 1.0.0
 * 생성일자		: 2007-12-05
 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can_boa.system.d05000003.activity;
...
{    
    ...
    public String runActivity(PosContext ctx)
    {
        ...
        if ( ctx.get(sDsName) != null ) {
	        ...
	        for ( int i = 0; i < nSize; i++ ) 
	        {
	            ...
	            logger.logInfo("dsMenuGrpValue=========================>>>>>>>"+record);
	        }
        }
        ...
        if ( ctx.get(sDsName) != null ) {
	        ...
	        {
	            PosRecord record = ds.getRecord(i);
	            logger.logInfo("dsMenuListValue=========================>>>>>>>"+record);
	        }
        }
    ...
    */
    ...
    protected int updateMenu(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdm_mn_um001", param);
    ...
    protected int insertMenu(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdm_mn_im001", param);
    ...
    protected int deleteMenu(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdm_mn_dm001", param);
        return dmlcount;
    }
    ...
    protected int deleteAuthMenu(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdm_mn_da002", param);
        return dmlcount;
    }    
}
