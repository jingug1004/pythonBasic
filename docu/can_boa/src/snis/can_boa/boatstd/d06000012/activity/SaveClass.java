/*================================================================================
 * 시스템			: 세부교육일정
 * 소스파일 이름	: snis.can.boatstd.d06000012.activity.SaveClass.java
 * 파일설명		: 코드 관리
 * 작성자			: 최문규
 * 버전			: 1.0.0
 * 생성일자		: 2007-01-03
 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can_boa.boatstd.d06000012.activity;
...
public class SaveClass extends SnisActivity 
{
     ...
     */
     ...
     protected int insertCls_Organ_Detl(PosRecord record) 
     {
        ...
        dmlcount = this.getDao("candao").insert("tbdn_cls_organ_detl_in000", param);
     ...
     protected int insertCls_Organ_Detl1(PosRecord record) 
     {
		...
		int dmlcount = this.getDao("candao").insert("tbdn_cls_organ_detl_in001", param);
...
//		String test4 = Util.trim(record.getAttribute("GUD_LECTR_ID"));
		...
		int dmlcount = this.getDao("candao").update("tbdn_cls_organ_detl_un001", param);
     ...
     protected int deleteCls_Organ_Detl(PosRecord record) 
     {
		...
		int dmlcount = this.getDao("candao").delete("tbdn_cls_organ_detl_dn001", param);
