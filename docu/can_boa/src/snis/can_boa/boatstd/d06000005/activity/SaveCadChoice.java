 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can_boa.boatstd.d06000005.activity;
...
//    	 사용자 정보 확인
    ...
    */
    ...
    protected int insertCadChoice(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, record.getAttribute("RECEIPT_YN")); 
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_rept_ib001", param);
    ...
    protected int updateCadChoice(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_rept_ub001", param);
    ...
    protected int deleteCadChoice(PosRecord record) 
    {
        ...
        int dmlcount  = this.getDao("candao").update("tbdn_selt_rept_db001", param);
    ...
    protected int insertFamList(PosRecord recHead,PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_fmly_ib001", param);
    	return dmlcount;
    }
    ...
    protected int updateFamList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_fmly_ub001", param);
    	return dmlcount;
    }
    ...
    protected int deleteFamList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").delete("tbdn_selt_fmly_db001", param);
    	return dmlcount;
    }
    ...
    protected int insertEduList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_schl_carr_ib001", param);
    	return dmlcount;
    }
    ...
    protected int updateEduList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_schl_carr_ub001", param);
    	return dmlcount;
    }
    ...
    protected int deleteEduList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").delete("tbdn_selt_schl_carr_db001", param);
    	return dmlcount;
    }
    ...
    protected int insertActList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_detl_carr_ib001", param);
    	return dmlcount;
    }
    ...
    protected int updateActList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_detl_carr_ub001", param);
    	return dmlcount;
    }
    ...
    protected int deleteActList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").delete("tbdn_selt_detl_carr_db001", param);
    	return dmlcount;
    }
    ...
    protected int insertCarList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_carr_ib001", param);
    	return dmlcount;
    }
    ...
    protected int updateCarList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_carr_ub001", param);
    	return dmlcount;
    }
    ...
    protected int deleteCarList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").delete("tbdn_selt_carr_db001", param);
    	return dmlcount;
    }
    ...
    protected int insertLicList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_cert_ib001", param);
    	return dmlcount;
    }
    ...
    protected int updateLicList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_cert_ub001", param);
    	return dmlcount;
    }
    ...
    protected int deleteLicList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").delete("tbdn_selt_cert_db001", param);
    	return dmlcount;
    }
    ...
    protected int insertFileList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").insert("tbdn_selt_file_ib001", param);
    	return dmlcount;
    }
    ...
    protected int updateFileList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").update("tbdn_selt_file_ub001", param);
    	return dmlcount;
    }
    ...
    protected int deleteFileList(PosRecord recHead, PosRecord recBody){
        ...
        int dmlcount = this.getDao("candao").delete("tbdn_selt_file_db001", param);
    	return dmlcount;
    }
}