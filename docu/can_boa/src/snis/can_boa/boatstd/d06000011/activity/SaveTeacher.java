 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.can_boa.boatstd.d06000011.activity;
...
public class SaveTeacher extends SnisActivity
{
     ...
     */
     ...
     protected int insertLecMan(PosRecord record) 
     {
         ...
         int dmlcount = this.getDao("candao").insert("tbdn_gud_lectr_d06000011_in001", param);
     ...
     protected int updateLecMan(PosRecord record) 
     {
         ...
         int dmlcount = this.getDao("candao").update("tbdn_gud_lectr_d06000011_un001", param);
     ...
     protected int deleteLecMan(PosRecord record) 
     {
         ...
         int dmlcount = this.getDao("candao").delete("tbdn_gud_lectr_d06000011_dn001", param);
