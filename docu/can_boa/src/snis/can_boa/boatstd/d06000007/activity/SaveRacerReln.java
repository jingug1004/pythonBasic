/*================================================================================
 * 시스템			: 후보생 경륜선수와 관계 관리
 * 소스파일 이름	: snis.can.system.d06000007.activity.SaveRacerReln.java
    ...
    */
    ...
    protected int insertSaveRacerReln(PosRecord record,PosRecord recHead) 
    {
        ...
        int dmlcount = 0;      
			...
			param.setValueParamter(i++, record.getAttribute("RELN_GBN"));
			param.setValueParamter(i++, record.getAttribute("RELN_DETL"));
			param.setValueParamter(i++, record.getAttribute("ADDR"));
			param.setValueParamter(i++, record.getAttribute("TEL"));
			param.setValueParamter(i++, record.getAttribute("RMK"));			
			param.setValueParamter(i++, SESSION_USER_ID);
			 	
			dmlcount += this.getDao("candao").insert("d06000007_ib005", param);
    ...
    protected int updateSaveRacerReln(PosRecord record)
    {
        ...
        int dmlcount = 0;
			...
			dmlcount += this.getDao("candao").update("d06000007_ub005", param);    
    ...
    protected int deleteSaveRacerReln(PosRecord record) 
    {
        ...
        int dmlcount  = this.getDao("candao").update("d06000007_db005", param);
