...
/*================================================================================
 * 시스템			: 후보생 가족사항 관리
 * 소스파일 이름	: snis.can.system.d06000007.activity.SaveFmly.java
 * 파일설명		: 후보생 가족사항 관리
 * 작성자			: 노인수
 * 버전			: 1.0.0
 * 생성일자		: 2008-03-06
...
{    
    ...
    */
    ...
    protected int insertSaveFmly(PosRecord record,PosRecord recHead){    	
		...
		param.setValueParamter(i++, record.getAttribute("FMLY_RELN"));
		...
		dmlcount += this.getDao("candao").insert("d06000007_ib002", param);
    ...
    protected int updateSaveFmly(PosRecord record)
    {
        ...
        int dmlcount = 0;
			...
			dmlcount += this.getDao("candao").update("d06000007_ub002", param);    
    ...
    protected int deleteSaveFmly(PosRecord record) 
    {
        ...
        int dmlcount  = this.getDao("candao").update("d06000007_db002", param);
