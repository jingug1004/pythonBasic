...
<ConnectGroup BkColor="white" Border="false" device="Win32&#32;(1024x768)" Font="Default,0" height="768" HideFrame="true" Id="SampleProject" ReSize="true" SessionURL="common::LoginSNIS.xml" Statusbar="true" Title="경주사업관리시스템" titlebar="true" TraceMode="new" UseUpdateMenu="true" version="1.0" width="1024" work_height="535" work_width="800">
    ...
    <Variables>
        <Var Comment="평가받는&#32;계약직&#32;사원&#32;사진&#32;URL(width&#32;:&#32;104&#32;/&#32;height&#32;:&#32;104)" Id="GBL_EVAL_PHOTO_URL" Type="Global" Value="http://ifis.kspo.or.kr:8090/snis/files/photo/hum/id/jong_persl/"/>
        ...
        <Var Comment="광명경륜장" Id="GBL_MEET_CD" Type="Global" Value="001"/>
        <Var Id="GBL_MENUID" Type="Global"/>
        <Var Comment="선수사진&#32;이미지&#32;URL" Id="GBL_PHOTO_URL" Type="Global" Value="http://www.kcycle.or.kr/h_image/"/>
        <Var Comment="레포트파일&#32;URL" Id="GBL_REPORT_URL" Type="Global" Value="http://localhost:8080/rbm/report/"/>
        ...
        <Var Comment="세션ID" Id="GBL_SESSIONID" Type="Global"/>
        <Var Comment="세션이&#32;끊긴상태&#32;여부" Id="GBL_SESSIONOFF" Type="Global"/>
    ...
    <GlobalStyle>
        <style BorderColor="#eeeeee" FixedFont="굴림,9" ID="snis_grid" TextColor="#333333"/>
        <style BorderColor="#d0c7d8" DisablebkColor="user61" DisableColor="user5" Font="굴림,9" Formcolor="#f7f7ff" ID="snis_if_input01" TextColor="user5"/>
        <style BorderColor="user6" DisablebkColor="#daede8" DisableColor="#777777" FixedFont="굴림,9" Font="굴림,9" Formcolor="user0" ID="snis_if_lable" TextColor="user5"/>
        ...
        <style BorderColor="#dddddd" DisablebkColor="user0" FixedFont="굴림,9" Formcolor="user9" ID="snis_m_lable" TextColor="user4"/>
        <style ID="snis_m_radio" TextColor="user5"/>
        <style FixedFont="굴림,9,Bold" Font="굴림,9,Bold" ID="snis_m_stitle" TextColor="user4"/>
        <style FixedFont="굴림체,9,Bold" Font="굴림,9,Bold" ID="snis_m_title" TextColor="user21"/>
        <style Font="굴림,9" ID="snis_txt" TextColor="user5"/>
    </GlobalStyle>
    <MDIInfo>
        <Forms OpenStyle="Max">
