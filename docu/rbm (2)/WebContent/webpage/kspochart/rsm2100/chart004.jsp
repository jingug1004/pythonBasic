...
<head>
	...
	$(function() {
		...
		$("#meet_nm").html("&nbsp;&nbsp;부&nbsp;&nbsp;산(판매금액)&nbsp;&nbsp;").css({top: 15, left:$(window).width()/2});
...
<body width="100%">
	<div width="100%" id="content">
		<div width="100%" class="bcrc-container">
			<div id="placeholder" class="bcrc-placeholder"></div>
		</div>
	</div>
</body>
</html>
