 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.rbm.business.rev2030.activity;
...
public class SaveSvrDt extends SnisActivity {
		public SaveSvrDt(){}
	    ...
	    */
	    protected void saveState(PosContext ctx) 
	    {
	        ...
	        if ( ctx.get(sDsNameSvr) != null ) {
		        ...
		        for ( int i = 0; i < nSize; i++ ) {
		            ...
		            nTempCnt = updateSvr(record);
		            nSaveCount = nSaveCount + nTempCnt;
			        continue;
		        }	        
	        }
	        
	        if ( ctx.get(sDsNameSvrDt) != null ) {
		        ds2   		 = (PosDataset) ctx.get(sDsNameSvrDt);
			        		...
			        		if(sAttFileKey != null && !sAttFileKey.equals("")) {
			        			...
			        			if(record.getAttribute ("ATT_FILE_KEY") == null || record.getAttribute("ATT_FILE_KEY").equals("")){ 			
			        				if(tmpFileKey == null || tmpFileKey.equals("")){
			        					...
			        					updateSvrDtFile(record);
			        				}
			        				record.setAttribute("ATT_FILE_KEY", tmpFileKey);
			        			}
			        		}
			        		
			        		record.setAttribute("TBL_NM", "TBRF_EV_WK_SRV_DT");
	     ...
	     * @throws  none
	     */
	    protected int updateSvrDt(PosRecord record2)
	    {			
	        ...
	        int dmlcount = this.getDao("rbmdao").update("rev2030_u01", param);
	        return i;
	    }
	    
	    protected int updateSvr(PosRecord record)
	    {			
	        ...
	        int dmlcount = this.getDao("rbmdao").update("rev2030_u02", param);
	        return i;
	    }
	     ...
	     * @throws  none
	     */
	    protected int updateSvrDtFile(PosRecord record)
	    {
	    	PosParameter param = new PosParameter();
	        int i = 0;          
	        ...
	        int dmlcount = this.getDao("rbmdao").update("rev2030_u03", param);
	        return dmlcount;
	    }
}
