...
public class UpdatePwd extends SnisActivity {
		public UpdatePwd(){}
	     ...
	     * @throws  none
	     */
	    protected int updatePwd(PosRecord record) 
	    {
	        ...
	        int dmlcount = this.getDao("rbmdao").update("rev3090_u01", param);
