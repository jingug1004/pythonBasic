...
public class UpdateStoppay extends SnisActivity {
    ...
    */
    ...
    protected int UpdateTsn(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, record.getAttribute("STOPPAY_ID"));
        param.setValueParamter(i++, record.getAttribute("STOPPAY_DT"));
        param.setValueParamter(i++, record.getAttribute("CNCL_ID"));
        param.setValueParamter(i++, record.getAttribute("CNCL_DT"));
