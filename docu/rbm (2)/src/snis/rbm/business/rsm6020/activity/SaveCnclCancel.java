...
public class SaveCnclCancel extends SnisActivity {
	
	public SaveCnclCancel(){}
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        if ( ctx.get(sDsName) != null ) {
	        ...
	        for ( int i = 0; i < nSize; i++ ) {
	            ...
	            nTempCnt = UpdateCnclCancelTsn(record);	//분실신고 지불정지 해지취소
     ...
     * @throws  none
     */
    protected int UpdateCnclCancelTsn(PosRecord record) 
    {
        ...
        dmlcount = this.getDao("rbmdao").update("rsm6020_u02", param);
        return dmlcount;        
