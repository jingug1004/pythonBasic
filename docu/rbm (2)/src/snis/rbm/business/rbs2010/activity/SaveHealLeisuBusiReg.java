...
public class SaveHealLeisuBusiReg extends SnisActivity {
	    ...
	    */
	    ...
	    {			           
	        ...
	        param.setValueParamter(i++, record.getAttribute("PRSN_QUOTA"));      // 11.정원
	    ...
	    {			
	        ...
	        param.setValueParamter(i++, record.getAttribute("PRSN_QUOTA"));                    // 10. 정원
	        
	        i = 0;
	        param.setWhereClauseParameter(i++, record.getAttribute("BUSI_CNTNT_CD"));   // 11. 사업내역코드
