...
public class SaveDbGitaFile extends SnisActivity {
    ...
    {  	
    	...
    	*/
    	...
    	int nSaveCnt = insertTbrdGitaCntnt(sPayYear, sPayMonth);
    ...
    /**
     * <p> 입력받은 년도/월의 기타소득세 저장 </p>
     * @param   record	PosRecord	데이타셋에 대한 하나의 레코드
     * @return  insertcount	int		insert 레코드 개수
     * @throws  none
     */
    protected int insertTbrdGitaCntnt(String sPayYear, String sPayMm) 
    {
        ...
        int nRtn = this.getDao("rbmdao").update("rsm5060_i03", param);
    ...
    protected int updateGitaCntntGrn(String sPayYear,String sPayMm) 
    {
        ...
        int dmlcount = 0;
        try{
        	dmlcount = this.getDao("rbmdao").update("rsm5060_u01", param);
        }catch(Exception e){
        	e.printStackTrace();
        }
