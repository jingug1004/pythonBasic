...
public class SaveTradeListMsr extends SnisActivity {
	
	public SaveTradeListMsr(){}
    ...
    */
    ...
    protected int saveList(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rem6011_i06", param);
        ...
        int dPercount = this.getDao("rbmdao").update("rem6011_i07", perparam);
    ...
    protected int deleteList(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rem6011_d06", param);
        ...
        int dPercount = this.getDao("rbmdao").update("rem6011_d07", perparam);
