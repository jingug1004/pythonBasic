 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.boa.financial.e07020065.activity;
...
* @version 1.0
*/
public class SearchTmsPrizStat extends SnisActivity
{    
    public SearchTmsPrizStat()
    {
    }
    ...
    public void getMonthPrizPerio(PosContext ctx)
    {
        ...
        PosRowSet rowSet =   this.getDao("boadao").find("tbeg_month_pay_ff201", param);
    ...
    public void getMonthPrizGrd(PosContext ctx)
    {
        ...
        PosRowSet rowSet =   this.getDao("boadao").find("tbeg_month_pay_ff202", param);
        ctx.put(sResultKey, rowSet);
        Util.addResultKey(ctx, sResultKey);
    }
    ...
    public void getMonthPrizAmt(PosContext ctx)
    {
        ...
        PosRowSet rowSet =   this.getDao("boadao").find("tbeg_month_pay_ff203", param);
        ctx.put(sResultKey, rowSet);
        Util.addResultKey(ctx, sResultKey);
    }    
