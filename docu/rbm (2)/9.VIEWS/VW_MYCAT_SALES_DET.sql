DROP VIEW USRBM.VW_MYCAT_SALES_DET;

/* Formatted on 2017-03-18 오전 10:59:44 (QP5 v5.136.908.31019) */
CREATE OR REPLACE FORCE VIEW USRBM.VW_MYCAT_SALES_DET
(
   RACE_DAY,
   MEET_CD,
   STND_YEAR,
