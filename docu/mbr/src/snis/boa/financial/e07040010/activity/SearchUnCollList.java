/*================================================================================
 * 시스템			: 상금관리 
 * 소스파일 이름	: snis.boa.financial.e07040010.activity.SearchUnCollList.java
 * 파일설명		: 미수금내역을 조회 한다.. 
 * 작성자			: 유재은 
 * 버전			: 1.0.0
 * 생성일자		: 2008-01-25
...
* @version 1.0
*/
public class SearchUnCollList extends SnisActivity
{    
    public SearchUnCollList()
    {
    }
    ...
    {	
    	if(logger.isDebugEnabled())logger.logDebug("=======================in runActivity ");
    	getRaceIms(ctx);
    ...
    private void getRaceIms(PosContext ctx)
    {
        ...
        rowset = getOrderRowSet(stndYear, payMonth, nmKor, collTpe);
     ...
     * @return
     */
    public PosRowSet getOrderRowSet(String stndYear, String payMonth, String nmKor, String collTpe)
    {
        ...
        param.setWhereClauseParameter(i++, collTpe);       
        return  this.getDao("boadao").find("tbeg_uncollected_ff001", param);
    } 
}
