package snis.boa.system.e01010180.activity;
...
public class SaveAlarmHist extends SnisActivity {
    ...
    */
    protected void saveState(PosContext ctx) 
    {
    	...
    	System.out.println("sAlarmGbn="+sAlarmGbn);    	
    	...
    	if(sAlarmGbn.equals("001")) {	
	    	...
	    	for (int i=0;i<aRecvId.length;i++) {
	        	...
	        	if (Util.lengthB(sCntnt) <= 90) {
		    		...
		    		System.out.println("#########insertAlarmSmsData ");
		    		//insertAlarmSmsData(record);			//SMS DATA 입력
	        	} else {
		    		sSmsSeqNo = getLmsDataSeq();
		    		record.setAttribute("SMS_SEQ_NO", sSmsSeqNo);
		    		System.out.println("#########insertAlarmLmsData ");
    ...
    protected int insertAlarmHist(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, record.getAttribute("RECV_USER_NM"));	//받는사람ID
        ...
        int dmlcount = this.getDao("boadao").update("e01010180_i01", param);
    ...
    protected int updateAlarmHist(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("boadao").update("e01010180_u01", param);
        return dmlcount;
    }
    ...
    protected int insertAlarmSmsData(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("boadao").update("e01010180_i02", param);
    ...
    {
        String rtnKey = "";
        PosRowSet keyRecord = this.getDao("boadao").find("e01010180_s02");        
    ...
    protected int insertAlarmLmsData(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("boadao").update("e01010180_i03", param);
    ...
    {
        String rtnKey = "";
        PosRowSet keyRecord = this.getDao("boadao").find("e01010180_s03");        
