 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.boa.equipment.e06010035.activity;
...
* @version 1.0
*/
public class SavePropeller extends SnisActivity
{    
	protected String sRacerNo      = "";
	protected String sSessionUserId = "";
	
    public SavePropeller()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        ds    = (PosDataset) ctx.get("dsOutPropeller");
        ...
        for ( int i = 0; i < nSize; i++ ){
            ...
            if ( record.getType() == com.posdata.glue.miplatform.vo.PosRecord.UPDATE 
                  ...
                  {
            		nSaveCount = nSaveCount + savePropeller(record);
                  }
        }
     ...
     * @throws  none
     */
    protected int savePropeller(PosRecord record)
    {
    	int effectedRowCnt = 0;
    	effectedRowCnt =  mergePropeller(record);
     ...
     * @throws  none
     */
    protected int mergePropeller(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("boadao").insert("tbef_propeller_mf001", param);
        return dmlcount;
    }
