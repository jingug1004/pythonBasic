/*================================================================================
 * 시스템			: 부품관리 
 * 소스파일 이름	: snis.boa.equipment.e06030060.activity.SearchPartsLack.java
 * 파일설명		: 부품 재고현황을 조회한다. 
 * 작성자			: 유재은 
 * 버전			: 1.0.0
 * 생성일자		: 2008-01-12
...
* @version 1.0
*/
public class SearchPartsLack extends SnisActivity
{    
    public SearchPartsLack()
    {
    }
    ...
    public PosRowSet getPartsRowSet(String stnd_year, String mbr_cd, String parts_cd, String parts_item_cd_nm)
    {
        ...
        return  this.getDao("boadao").find("tbef_parts_lack_ff001", param);
    }
