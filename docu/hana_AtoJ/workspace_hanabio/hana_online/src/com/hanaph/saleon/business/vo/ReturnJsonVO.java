...
public class ReturnJsonVO {
	...
	private List<ReturnVO> rows; // list
	private ReturnVO totalCountInfo; // 합계 정보
	 ...
	 * @return the rows
	 */
	public List<ReturnVO> getRows() {
		return rows;
	}
	/**
	 * @param rows the rows to set
	 */
	public void setRows(List<ReturnVO> rows) {
		this.rows = rows;
	}
	/**
	 * @return the totalCountInfo
	 */
	public ReturnVO getTotalCountInfo() {
		return totalCountInfo;
	}
	/**
	 * @param totalCountInfo the totalCountInfo to set
	 */
	public void setTotalCountInfo(ReturnVO totalCountInfo) {
