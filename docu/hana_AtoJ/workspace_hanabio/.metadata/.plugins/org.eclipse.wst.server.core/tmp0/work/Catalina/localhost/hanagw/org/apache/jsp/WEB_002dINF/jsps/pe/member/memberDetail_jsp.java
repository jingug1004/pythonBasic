 ...
 * Generated at: 2015-06-16 01:46:34 UTC
...
if(menuVO.getMenu_child().length() == 6) {
      ...
      out.write("\t\t\t\t<div class=\"wrap_personal_info_edit\">\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t<col style=\"width:110px;\" />\r\n");
      out.write("\t\t\t\t\t\t\t<col style=\"width:230px;\" />\r\n");
      out.write("\t\t\t\t\t\t\t<col style=\"width:110px;\" />\r\n");
      out.write("\t\t\t\t\t\t\t<col />\r\n");
      out.write("\t\t\t\t\t\t\t<col />\r\n");
      out.write("\t\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"no_bd\">\r\n");
      out.write("\t\t\t\t\t\t\t<th>사원번호</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"photo_pd\">");
      out.print(memberDetailVO.getEmp_no() );
      out.write("<button type=\"button\" class=\"type_01 ml35\" onclick=\"javascript:Commons.popupOpen('passChg', '");
      out.print(GROUP_ROOT);
      out.write("/co/login/passwordChangeForm.do', '290', '239'); return false;\">비밀번호 변경</button></td>\r\n");
      out.write("\t\t\t\t\t\t\t<th>성명</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getEmp_ko_nm()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td rowspan=\"4\" class=\"photo\"><img src=\"");
      out.print(GROUP_ROOT );
      out.write("/pe/member/memberPhoto/");
      out.print(StringUtil.nvl(memberDetailVO.getEmp_no()) );
      out.write(".do\"  onerror=\"this.src='");
      out.print(GROUP_WEB_ROOT);
      out.write("/img/character.gif'\" alt=\"사진\" alt=\"사진\"  /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>성명(영문)</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getEmp_en_nm()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<th>부서</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getDept_ko_nm()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>직급</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getGrad_ko_nm()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<th>진급일자</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getProcm_dt()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>입사일자</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getEncmpy_dt()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<th>생년월일</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getBirth_dt()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<col />\r\n");
      out.write("\t\t\t\t\t\t<tr class=\"no_bd\">\r\n");
      out.write("\t\t\t\t\t\t\t<th colspan=\"4\" class=\"ta_c\">추가정보</th>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t<td colspan=\"3\">");
      out.print(StringUtil.nvl(memberDetailVO.getAddr1()) );
      out.write(' ');
      out.print(StringUtil.nvl(memberDetailVO.getAddr2()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>영문주소</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"3\">");
      out.print(StringUtil.nvl(memberDetailVO.getAddr_en()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>전화번호</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getTel_no()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<th>사내전화번호</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getIn_tel()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>모바일전화</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(memberDetailVO.getPager_no()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<th class=\"bdnone\">이메일</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"bdnone\">");
      out.print(StringUtil.nvl(memberDetailVO.getE_mail()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>비고</th>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"3\" class=\"last\">");
      out.print(StringUtil.nvl(memberDetailVO.getAuth_nm()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\r\n");
