...
public final class annualList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(menuVO.getMenu_child().length() == 6) {
      ...
      out.write("\t\t\t\t<button class=\"btn_search\" onclick=\"javascript:goSearch(); return false;\">검색</button>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(annualVO.getRq_vacat_nm()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(annualVO.getRq_fr_dt()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(annualVO.getRq_to_dt()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td");
      out.print("42020".equals(annualVO.getRq_vacat_cd())?" class='fc_b'": " class='fc_r'");
      out.write('>');
      out.print(annualVO.getRq_wk_day());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(annualVO.getRq_remark()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\">총 연차사용일수</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(annualUsedCount);
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t</tr>\t\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.print(StringUtil.makeMoneyType(annualTotalCount));
      out.write("</span>건\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t");
      out.write('\r');
