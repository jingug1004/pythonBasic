...
<%--
 * @파일명 : previewE01012.jsp
 * @메뉴명 : 결재문서 미리보기 - 시간외근무내역서
 * @최초작성일 : 2015/01/28            
 * @author : CHOIILJI                 
 * @수정내역 : 
--%>
			...
			<table class="tbl_sample">
				...
				%>
					<tr>
						...
						<td class="bdr2"><%=String.format("%02d", Integer.parseInt(overtimeVO.getWork_real_hh())) %> : <%=String.format("%02d", Integer.parseInt(overtimeVO.getWork_real_mi()))%></td>
					</tr>
				<%		
					}
				}	
