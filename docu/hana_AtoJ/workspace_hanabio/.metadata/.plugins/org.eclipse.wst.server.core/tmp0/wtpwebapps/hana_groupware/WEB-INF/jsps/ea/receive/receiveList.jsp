		...
		<form id="searchForm" name="searchForm" method="post">
			<ul class="serch_con01">
				...
				<li class="cont02">
					...
					<input class="serch_txt03 w305" type="text" id="searchKeyword" name="searchKeyword" maxlength="32" value="<%=searchKeyword%>" onKeyPress="if(event.keyCode=='13'){goSearch(); return false;}" >
