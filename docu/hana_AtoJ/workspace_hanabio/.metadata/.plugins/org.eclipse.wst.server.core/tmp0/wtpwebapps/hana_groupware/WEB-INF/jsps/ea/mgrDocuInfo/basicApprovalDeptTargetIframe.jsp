...
<%--
 * @파일명 : basicApprovalDeptTargetIframe.jsp
 * @메뉴명 : 기본결재라인 시행부서 대상 iframe
 * @최초작성일 : 2015/01/28            
 * @author : CHOIILJI                 
 * @수정내역 : 
--%>
...
<%
	//시행
	List<BasicImplDeptVO> basicImplDeptDetailList = (List<BasicImplDeptVO>)request.getAttribute("basicImplDeptDetailList");
%>
<!DOCTYPE html>
<html lang="ko">
<head>
