 ...
 * Generated at: 2015-04-28 04:08:29 UTC
...
public final class customerListPopup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String JDBC_URL = env.getValue("jdbc.url");
      ...
      out.write("\t\t/* 회전일 현황 화면에서 사용하기 위해. 창 이름이 as_fr_rcust일 경우 거래처를 판매처로 변경*/\r\n");
      out.write("\t\tvar custNameType = \"거래\";\r\n");
      out.write("\t\tif(self.name == 'as_fr_rcust'){\r\n");
      out.write("\t\t\tcustNameType = \"매출\";\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$('h1.tit').html(custNameType+'처');\r\n");
      out.write("\t\t\t$('div.wrap_pop_search label').html(custNameType+'처코드/명');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("    \t}\r\n");
      out.write("\t\r\n");
      out.write("\t\t/* 거래처 목록 jqgrid */\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid({\r\n");
      out.write("\t\t\tmtype:\"get\", // 요청방식\r\n");
      out.write("\t\t\tdatatype:\"json\", // 결과물 받을 데이터 타입\r\n");
      out.write("\t\t\tcolNames:[custNameType+\"처코드\",custNameType+\"처명\",\"사업자번호\",\"대표자명\",\"사원코드\",\"사원명\"], // 컬럼명  \r\n");
      out.write("\t\t\tcolModel:[\r\n");
      out.write("\t\t\t\t\t\t{name:\"cust_id\",\tindex:\"cust_id\", \talign:\"center\",\twidth:90},\r\n");
      out.write("\t\t\t\t\t\t{name:\"cust_nm\",\tindex:\"cust_nm\", \talign:\"left\"},\r\n");
      out.write("\t\t\t\t\t\t{name:\"vou_no\",\t\tindex:\"vou_no\", \talign:\"center\",\twidth:140, formatter:vouNoFormatter},\r\n");
      out.write("\t\t\t\t\t\t{name:\"president\",\tindex:\"president\", \talign:\"left\",\twidth:90},\r\n");
      out.write("\t\t\t\t\t\t{name:\"sawon_id\",\tindex:\"sawon_id\", \talign:\"center\", width:60},\r\n");
      out.write("\t\t\t\t\t\t{name:\"sawon_nm\",\tindex:\"sawon_nm\", \talign:\"left\",\twidth:90}\r\n");
      out.write("\t\t\t\t\t],\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\tif (data.records < 1) {\r\n");
      out.write("\t\t\t\t\talert(\"해당 \"+custNameType+\"처가 없습니다.\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\r\n");
      out.write("\t\t\t/* row 더블 클릭 시 이벤트 */\r\n");
      out.write("\t\t\tondblClickRow: function(){\r\n");
      out.write("\t\t\t\tBusiness.selectValue('customer'); // 팝업을 닫고 부모창에 선택한 값 셋팅\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t$(\"#grid_list\").setGridWidth($(\"#result\").width() , true);\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t/* 거래처 목록 조회 */\r\n");
      ...
      out.write("\t\tvar param = \"searchKeyword=\" + encodeURI(encodeURIComponent(searchKeyword));\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 호출 */\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid('setGridParam',{url:\"");
      out.print(ONLINE_ROOT);
      out.write("/business/common/customerGridList.do?\" + param}).trigger(\"reloadGrid\");\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t/* 사업자번호 커스텀 포맷 */\r\n");
      ...
      out.write("\t\t<h1 class=\"tit\">거래처</h1>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"wrap_pop_search\">\r\n");
      out.write("\t\t\t<label>거래처코드/명</label>\r\n");
      out.write("\t\t\t<input type=\"text\" class=\"w330\" maxlength=\"10\" id=\"searchKeyword\" name=\"searchKeyword\" />\r\n");
      out.write("\t\t\t<button type=\"button\" onclick=\"javascript:getGridList();\" >조회</button>\r\n");
      out.write("\t\t\t<button type=\"button\" onclick=\"javascript:Business.selectValue('customer');\" >선택</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"pop_grid box_type01 h440\" id=\"result\">\r\n");
