 ...
 * Generated at: 2015-04-28 07:04:47 UTC
...
public final class turnsdayList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(null != commonEmpInfo) { // null이 아닐 경우
      ...
      out.write("\t\t\tcolNames:[\"*일자*\", \"거래처코드\", \"거래처명\", \"매출처코드\", \"매출처명\", \"제품코드\", \"제품명\", \"규격\"],\r\n");
      out.write("\t\t\tcolModel:[\r\n");
      ...
      out.write("\t\t\tloadonce : true,\t\t\t\t\t\t\t//처음만 DB 조회, 그 후에는 그 조회된 테이터로 정렬함. 페이징처리 안 된 그리드에서 사용\r\n");
      out.write("\t\t\t/* 조회 완료 시 호출 */\r\n");
      out.write("\t\t\tloadComplete: function(data){\r\n");
      out.write("\t\t\t\tif(data.length && data.length > 0){\r\n");
      out.write("\t\t\t\t\t$(\"#grid_list\").jqGrid('setGridParam',{rowNum : data.length});\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(!saleActionFlag && data.length && data.length > 0) {\r\n");
      out.write("\t\t\t\t\tsaleActionFlag = true; // 인쇄, 엑셀 사용 가능하도록\r\n");
      out.write("\t\t\t\t} else if(!saleActionFlag && (!data.length || data.length < 1)){\r\n");
      out.write("\t\t\t\t\talert(\"해당 자료가 없습니다.\");\r\n");
      ...
      out.print(ONLINE_ROOT);
      out.write("/business/turnsdayGridListExcelDown.do', '');\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 닫기 버튼 클릭 */\r\n");
      out.write("\t\t$(\"#p_close\").on(\"click\",function(){\r\n");
      out.write("\t\t\tparent.Commons.closeTab('회전일현황');\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tvar as_fr_rcust = $(\"#as_fr_rcust\").val();\r\n");
      out.write("\t\tvar as_dept_cd = $(\"#as_dept_cd\").val();\r\n");
      out.write("\t\tvar as_pda_auth = $(\"#as_pda_auth\").val();\r\n");
      out.write("\t\tvar dc_en_yn = $(\"#dc_en_yn\").val();\r\n");
      out.write("\t\tvar gc_en_yn = $(\"#gc_en_yn\").val();\r\n");
      out.write("\t\tvar dw_gb = $(\"#dw_gb\").val();\r\n");
      out.write("\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 유효성 체크 */\r\n");
      ...
      out.write("\t\t\tas_fr_rcust : as_fr_rcust,\r\n");
      out.write("\t\t\tas_dept_cd : as_dept_cd,\r\n");
      out.write("\t\t\tas_pda_auth : as_pda_auth,\r\n");
      out.write("\t\t\tdc_en_yn : dc_en_yn,\r\n");
      out.write("\t\t\tgc_en_yn : gc_en_yn,\r\n");
      out.write("\t\t\tdw_gb : dw_gb\r\n");
      out.write("\t\t};\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t$(\"#grid_list\").jqGrid('setGridParam',{rowNum : -1});\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid('setGridParam',{loadonce : false});\t\t//조회 버튼 클릭시에는 DB조회되도록\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid('setGridParam',{loadonce : false, mtype:\"get\", datatype:\"json\", url:\"");
      out.print(ONLINE_ROOT);
      out.write("/business/turnsdayGridList.do?\" + paramStr}).trigger(\"reloadGrid\");\t//조회 버튼 클릭시 DB조회 되도록\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid('setGridParam',{loadonce : true});\t\t\t//조회 한 후에는 다시  loadonce를 true로 변경\r\n");
      out.write("\t\tsaleActionFlag = false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t</script>\r\n");
      ...
      out.print(pda_auth );
      out.write("\" />\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"dc_en_yn\" id=\"dc_en_yn\" value=\"%\" />\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"gc_en_yn\" id=\"gc_en_yn\" value=\"%\" />\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"dw_gb\" id=\"dw_gb\" value=\"2\" />\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t\t<input type=\"text\" class=\"w80\" maxlength=\"10\" id=\"as_fr_cust\" name=\"as_fr_cust\" onblur=\"javascript:Business.getCustomerName(this.id);\"/>\r\n");
      ...
      out.write("\t\t\t\t&nbsp;\r\n");
      out.write("\t\t\t\t<label>매출처</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"w80\" maxlength=\"10\" id=\"as_fr_rcust\" name=\"as_fr_rcust\" onblur=\"javascript:Business.getCustomerName(this.id);\"/>\r\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"btn_search\" onclick=\"javascript:Commons.popupOpen('as_fr_rcust', '");
      out.print(ONLINE_ROOT);
      out.write("/business/common/customerList.do', '600', '655');\" ><span class=\"blind\">찾기</span></button>\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"w140 ipt_disable\" id=\"as_fr_rcust_name\" name=\"as_fr_rcust_name\" readonly />\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t<div class=\"float_l\" style=\"color:#ee3333\">\r\n");
      out.write("\t\t\t\t\t※ 회전일 정보는 엑셀출력시에만 보입니다.\r\n");
      out.write("\t\t\t\t</div>\r\n");
