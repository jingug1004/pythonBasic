...
/**
 * <pre>
 * Class Name : NewReportE01010DAO.java
 * 설명 : 증명서 발급 신청서 DAO
 * 
 ...
 * @since   : 2015. 1. 16.
 */
public interface NewReportE01010DAO {

	/**
	 * 
	 * <pre>
	 * 1. 개요     : 증명서 발급 신청서 등록한다.
	 * 2. 처리내용 : 증명서 발급 신청서 등록한다.
	 * </pre>
	...
	/**
	 * <pre>
	 * 1. 개요     : 증명서발급신청서 수정을 한다. 
	 * 2. 처리내용 : 증명서발급신청서 수정을 한다.
	 * </pre>
