...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '/hanagw/asset/js/nicEdit/nicEditorIcons.gif',
...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		//console.log('panelInstance : '+e.getStyle('width') +'/'+ e.clientWidth);
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		//console.log('nicEditorInstance : '+e.getStyle('width') +'/'+ e.clientWidth);
		newX = e.clientWidth;
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var s = {width: '100%', border : '0px solid #ccc', borderTop : 0, overflowY : 'auto', overflowX: 'hidden' };
			s[(ie7s) ? 'height' : 'maxHeight'] = (this.ne.options.maxHeight) ? this.ne.options.maxHeight+'px' : null;
			this.editorContain = new bkElement('DIV').setStyle(s).appendBefore(e);
			var editorElm = new bkElement('DIV').setStyle({width : '100%', margin: '4px', minHeight : newY+'px'}).addClass('main').appendTo(this.editorContain);
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	//nicURI : '/hanagw/board/imgEditorFileUpload.do',
  ...
  uploadFile : function() {
    ...
    xhr.open("POST", $('#uploadEditorUrl').val(), false);
    xhr.onload = function() {
      try {
