...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=GROUP_WEB_ROOT%>/css/main.css" />
	<link rel="stylesheet" type="text/css" href="<%=GROUP_WEB_ROOT%>/css/fonts.css" />
	<link rel="stylesheet" type="text/css" href="<%=GROUP_WEB_ROOT%>/css/dtree.css" />
	<link rel="stylesheet" type="text/css" href="<%=GROUP_WEB_ROOT%>/css/smoothness/jquery-ui-1.10.4.custom.css" />
	<script type="text/javascript" src="<%=GROUP_WEB_ROOT%>/js/jquery-1.11.1.min.js"></script>
	<script type="text/javascript" src="<%=GROUP_WEB_ROOT%>/js/jquery-ui-1.10.4.custom.js"></script>
	<script type="text/javascript" src="<%=GROUP_WEB_ROOT%>/js/jquery.bpopup.min.js"></script>
	<script type="text/javascript" src="<%=GROUP_WEB_ROOT%>/js/common.js"></script>
	<script type="text/javascript" src="<%=GROUP_WEB_ROOT%>/js/dtree.js" ></script>
			...
			<div class="cont float_left">
				<div class="list_btn last_step">
					<div class="list_button tar">
						<button type="button" onclick="javascripr:Commons.directPreviewOpen('yearendtaxPrint', '850', '900');">인쇄</button>
					</div>
				</div>
				<div class="wrap_withholding_receipt" id="yearendtaxPrint">
					<div class="wrap_receipt_container">
						<div id="tab1" class="wrap_receipt_midbox">
							...
							<div class="wrap_receipt">
								...
								<div class="summary">
									...
									<div>
										<p>위의 원천징수액(근로소득)을 영수(지급)합니다. <span><em><%=yearendtaxDetail.getBas_end_dt().substring(0,4)%></em>년 <em><%=yearendtaxDetail.getBas_end_dt().substring(4,6)%></em>월 <em><%=yearendtaxDetail.getBas_end_dt().substring(6,8)%></em>일</span></p>
										<div>
						...
						<div id="tab2" class="wrap_receipt_midbox" style='page-break-before:always'>
						...
						<div id="tab3" class="wrap_receipt_midbox" style='page-break-before:always'>
