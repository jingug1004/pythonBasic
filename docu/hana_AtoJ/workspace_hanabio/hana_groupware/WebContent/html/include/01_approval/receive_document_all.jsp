...
<div class="cont float_left">
	<div class="wrap_receive_document_all">
		<h2>내가받은문서 <span class="type">전체</span></h2>
		...
		<div class="serch_box">
			<ul class="serch_con01">
				<li>
					...
					<span class="sc_txt02 ml60">문서상태</span>
				...
				<li class="cont02">
					...
					<input class="serch_txt03 w275" type="text">
				</li>
			</ul>
		...
		<!-- <div class="list_btn">
			<span class="list_t">* 참조로 검색한 경우 열람 <span class="none_check">Y</span>, 미열람 <span class="none_check">N</span>으로 표시됩니다.</span>
		</div> -->
