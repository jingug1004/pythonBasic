...
(function($){
	...
	function setScrollers(container) {
		...
		var wrapSize = wrap.children('div.tabs-wrap-size');
		var sLeft = wrap.children('div.tabs-scroller-left');
		var sRight = wrap.children('div.tabs-scroller-right');
		...
		var wsWidth = wrapSize.width() - tool._outerWidth();	// ul.tabs width
		if(sLeft.css('display') == 'block' ){
			wsWidth = wsWidth + sLeft.outerWidth();
		}
		if(sRight.css('display') == 'block' ){
			wsWidth = wsWidth + sRight.outerWidth();
		}
		
		if (tabsWidth > wsWidth) {
			...
			if (opts.toolPosition == 'left'){
				...
				wrapSize.css({
					marginLeft: (sLeft.outerWidth() + tool._outerWidth()) + (header.width() - wsWidth) / 2,
					marginRight: sRight._outerWidth() + (header.width() - wsWidth) / 2,
					width: wsWidth - sLeft.outerWidth() - sRight.outerWidth()
				});
				
				var sLeft_left = wrapSize.offset().left - sLeft.outerWidth();
				var sRight_left = wrapSize.offset().left + wrapSize.outerWidth();
				if(wrapSize.offset().left < sLeft.outerWidth()){
					sLeft_left = 0;
					sRight_left = wrapSize.offset().left + wrapSize.outerWidth() - sRight.outerWidth();
				}
				
				sLeft.css({left: sLeft_left, 'z-index':'999'});
				sRight.css({left: sRight_left, 'z-index':'999'});
	...
	function setSize(container, param) {
		...
		if(opts.headerTotalWidth && opts.headerTotalWidth > 0 && opts.headerTotalWidth > $('body').innerWidth()){
			opts.width = opts.headerTotalWidth;
		} else {
			opts.width = $('body').innerWidth();
		}
		cc._size(opts);
...
//			header._outerWidth(opts.headerWidth);
			...
			if(opts.headerTotalWidth && opts.headerTotalWidth > 0 && opts.headerTotalWidth <= tabsWidth){
				ul._outerHeight(opts.tabHeight).css('width',tabsWidth*2);
			} else {
...
//		cc.wrapInner('<div class="tabs-panels"/>');
		var tabSizeHtml = '<div class="tabs-wrap-size">';
		if(opts.headerTotalWidth && typeof opts.headerTotalWidth != undefined && opts.headerTotalWidth > 0){
			tabSizeHtml = '<div class="tabs-wrap-size" style="width:' + opts.headerTotalWidth + 'px; margin:0 auto; overflow: hidden;">';
		}
...
//		}
	...
	function selectTab(container, which){
		...
		var wrap = $(container).find('>div.tabs-header>div.tabs-wrap>div.tabs-wrap-size');
		var left = tab.position().left;
		var right = left + tab.outerWidth();
		var wrapLeft = wrap.offset().left;
		if (left < wrapLeft || right > (wrapLeft+wrap.width())){
			var deltaX = (left - (wrap.width()-tab.width()) / 2) - wrapLeft;
		...
		try{Commons.resizePanel();}catch(e){}
	}
	...
	$.fn.tabs.methods = {
		...
		scrollBy: function(jq, deltaX){	// scroll the tab header by the specified amount of pixels
			return jq.each(function(){
				...
				var wrap = $(this).find('>div.tabs-header>div.tabs-wrap>div.tabs-wrap-size');
	...
	$.fn.tabs.parseOptions = function(target){
		return $.extend({}, $.parser.parseOptions(target, [
			...
			{fit:'boolean',border:'boolean',plain:'boolean',headerWidth:'number',tabWidth:'number',tabHeight:'number',selected:'number',showHeader:'boolean',headerTotalWidth:'number'}
		]));
	};
...
_8a0.push({iconCls:"combo-arrow",handler:function(e){
_8a4(e.data.target);
}});
}
$(_89c).addClass("combo-f").textbox($.extend({},opts,{icons:_8a0,onChange:function(){
}}));
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_8ac,keydown:_8b0,paste:_8b0,drop:_8b0},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
$(_911).combo($.extend({},opts,{onShowPanel:function(){
...
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_923){
return _923;
...
$.ajax({type:opts.method,url:opts.url,data:_924,dataType:"json",success:function(data){
_925(data);
},error:function(){
...
return data;
},finder:{getEl:function(_927,_928){
...
var grid=_94b.grid;
$(_94a).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
...
$(_974).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_976();
...
$.extend(_975.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
...
_97c(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_98f){
...
$(_994).datebox($.extend({},opts,{onShowPanel:function(){
...
$(_994).datebox("calendar").calendar({onSelect:function(date){
...
_9cb.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_9ea){
return _9ea;
},converter:{toPosition:function(_9eb,size){
var opts=$(this).slider("options");
