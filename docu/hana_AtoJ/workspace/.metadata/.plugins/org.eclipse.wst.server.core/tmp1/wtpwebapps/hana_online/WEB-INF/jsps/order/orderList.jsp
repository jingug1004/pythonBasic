...
<head>
	...
	$(document).ready(function(){
		...
		var param = "fr_date="+$("#fr_date").val()+"&to_date="+$("#to_date").val()+"&receipt_gb=00&receipt_gb=01&receipt_gb=03";	//주문 master 조회 파라메터  set
	...
	<form id="frm" name="frm" method="post">
		...
		<div class="wrap_search">
			<div class="search">
				...
				<span>반려</span>
				 -->
				<%--# ml.008 orderList.jsp의 접수, 승인, 반려 1 -> 01, 2 -> 09로 수정 - ORAGMP.SLORDM.STATEDIV 기준값 맞추기 위해서 - 김진국--%>
				<label class="ml10">주문상태</label>
				<input type="checkbox" id="status1" name="receipt_gb" value="01" checked="checked"/>
				<%--<input type="checkbox" id="status1" name="receipt_gb" value="01" checked="checked"/>--%>
				<span>등록</span>
				<input type="checkbox" id="status3" name="receipt_gb" value="03" checked="checked"/>
				<%--<input type="checkbox" id="status3" name="receipt_gb" value="99" checked="checked"/>--%>
				<span>승인</span>
