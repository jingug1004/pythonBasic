 ...
 * Generated at: 2015-04-29 01:50:55 UTC
...
public final class empListPopup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String JDBC_URL = env.getValue("jdbc.url");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t/* 부모창에 검색조건이 있을 경우 셋팅해준다. */\r\n");
      out.write("\t\t$(\"#dept_cd\").val($(\"#as_team_cd\", opener.document).val()); // 부서코드 셋팅\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("    \t}\r\n");
      out.write("\r\n");
      out.write("\t\t/* 사원 목록 jqgrid */\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid({\r\n");
      out.write("\t\t\tmtype:\"get\", // 요청방식\r\n");
      out.write("\t\t\tdatatype:\"json\", // 결과물 받을 데이터 타입\r\n");
      out.write("\t\t\tcolNames:[\"사원코드\",\"사원명\",\"재직구분\",\"부서명\"], // 컬럼명\r\n");
      out.write("\t\t\tcolModel:[\r\n");
      out.write("\t\t\t\t\t\t{name:\"emp_id\"  ,index:\"emp_id\"  ,align:\"center\" , width:200},\r\n");
      out.write("\t\t\t\t\t\t{name:\"emp_nm\"  ,index:\"emp_nm\"  ,align:\"center\"   , width:200},\r\n");
      out.write("\t\t\t\t\t\t{name:\"gubun\"   ,index:\"gubun\"   ,align:\"center\" , width:100 , formatter:gubunFormatter},\r\n");
      out.write("\t\t\t\t\t\t{name:\"dept_nm\" ,index:\"dept_nm\" ,align:\"left\"   , width:300}\r\n");
      out.write("\t\t\t\t\t],\r\n");
      ...
      out.write("\t\t\t\t\talert(\"해당 사원이 없습니다.\"); // 팝업을 닫고 부모창에 선택한 값 셋팅\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t/* row 더블 클릭 시 이벤트 */\r\n");
      out.write("\t\t\tondblClickRow: function(){\r\n");
      out.write("\t\t\t\tBusiness.selectValue('emp');\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t/* 재직구분 커스텀 포맷 */\r\n");
      out.write("\tfunction gubunFormatter(cellvalue){\r\n");
      out.write("\t\tvar returnValue = \"\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif (\"Y\" == cellvalue) {\r\n");
      out.write("\t\t\treturnValue = \"재직\";\r\n");
      out.write("\t\t} else if (\"N\" == cellvalue) {\r\n");
      out.write("\t\t\treturnValue = \"퇴직\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tvar dept_cd = $(\"#dept_cd\").val();\r\n");
      out.write("\t\tvar param = \"searchKeyword=\" + encodeURI(encodeURIComponent(searchKeyword)) + \"&dept_cd=\" + dept_cd;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 호출 */\r\n");
      out.write("\t\t$(\"#grid_list\").jqGrid('setGridParam',{url:\"");
      out.print(ONLINE_ROOT);
      out.write("/business/common/empGridList.do?\" + param}).trigger(\"reloadGrid\");\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t<h1 class=\"tit\">사원조회</h1>\r\n");
      out.write("\t\r\n");
      out.write("\t\t<div class=\"wrap_pop_search\">\r\n");
      out.write("\t\t\t<label>사원코드/명</label>\r\n");
      out.write("\t\t\t<input type=\"text\" class=\"w340\" maxlength=\"20\" id=\"searchKeyword\" name=\"searchKeyword\" />\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"dept_cd\" id=\"dept_cd\" />\r\n");
      out.write("\t\t\t<button type=\"button\" onclick=\"javascript:getGridList();\" >조회</button>\r\n");
      out.write("\t\t\t<button type=\"button\" onclick=\"javascript:Business.selectValue('emp');\" >선택</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
