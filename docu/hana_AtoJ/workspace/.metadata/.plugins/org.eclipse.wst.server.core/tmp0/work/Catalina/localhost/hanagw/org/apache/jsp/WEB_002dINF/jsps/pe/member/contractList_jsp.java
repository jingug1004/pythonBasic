 ...
 * Generated at: 2015-06-16 04:37:39 UTC
...
com.hanaph.gw.co.common.utils.Environment env = new com.hanaph.gw.co.common.utils.Environment();
	...
	int contractTotalCount = (Integer)request.getAttribute("contractTotalCount");
      ...
      out.write("\t * 상세페이지 이동\r\n");
      out.write("\t */\r\n");
      out.write("\tfunction goContract(ymd_start, ymd_end){\r\n");
      out.write("\t\tdocument.getElementById(\"ymd_start\").value = ymd_start;\r\n");
      out.write("\t\tdocument.getElementById(\"ymd_end\").value = ymd_end;\r\n");
      out.write("\t\tdocument.getElementById(\"frm\").action =\"");
      out.print(GROUP_ROOT);
      out.write("/pe/member/contractDetail.do\";\r\n");
...
if(menuVO.getMenu_child().length() == 6) {
      ...
      out.write("\t\t\t<h2>연봉계약서</h2>\r\n");
      out.write("\t\t\t<div class=\"wrap_pay_on_inquiry\">\r\n");
      out.write("\t\t\t\t<div class=\"wrap_list mt20\">\r\n");
      out.write("\t\t\t\t\t<div class=\"tableA\">\r\n");
      out.write("\t\t\t\t\t<form name=\"frm\" id=\"frm\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"ymd_start\" name=\"ymd_start\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"ymd_end\" name=\"ymd_end\">\r\n");
      out.write("\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>계약기간</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>연봉지급액</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>해당기간퇴직금</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>근무개월</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"br_none\">연봉계약서출력일</th>\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr style=\"cursor:pointer;\" class=\"bg_d\" onclick=\"javascript:goContract('");
      out.print(StringUtil.nvl(contractVO.getYmd_start()));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(StringUtil.nvl(contractVO.getYmd_end()));
      out.write("'); return false;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(contractVO.getYmd_start_ko()));
      out.write(' ');
      out.write('~');
      out.write(' ');
      out.print(StringUtil.nvl(contractVO.getYmd_end_ko()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(contractVO.getAnnual_salary()));
      out.write(" 원</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(contractVO.getSeverance_pay()));
      out.write(" 원</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(contractVO.getWork_months()));
      out.write(" 개월</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td class=\"br_none\">");
      out.print(StringUtil.nvl(contractVO.getYmd_output_ko()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.print(StringUtil.makeMoneyType(contractTotalCount));
      out.write("</span>건\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t");
      out.write('\r');
