...
com.hanaph.gw.co.common.utils.Environment env = new com.hanaph.gw.co.common.utils.Environment();
	...
	int salaryTotalCount = (Integer)request.getAttribute("salaryTotalCount");
      ...
      out.write("\t * 상세페이지 이동\r\n");
      out.write("\t */\r\n");
      out.write("\tfunction goSalary(pay_date){\r\n");
      out.write("\t\tdocument.getElementById(\"pay_date\").value = pay_date;\r\n");
      out.write("\t\tdocument.getElementById(\"frm\").action =\"");
      out.print(GROUP_ROOT);
      out.write("/pe/member/salaryDetail.do\";\r\n");
      ...
      out.write("\t\tdocument.getElementById(\"frm\").action =\"");
      out.print(GROUP_ROOT);
      out.write("/pe/member/salaryList.do\";\r\n");
      out.write("\t\tdocument.getElementById(\"frm\").submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
...
if(menuVO.getMenu_child().length() == 6) {
      ...
      out.write("\t\t\t\t<h2>급여조회</h2>\r\n");
      out.write("\t\t\t\t<div class=\"wrap_pay_on_inquiry\">\r\n");
      out.write("\t\t\t\t\t<form name=\"frm\" id=\"frm\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"pay_date\" name=\"pay_date\">\r\n");
      out.write("\t\t\t\t\t<div class=\"wrap_search\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"float_l\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"txt\">조회기간</span>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"wrap_carendar\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"search_start_dt\" name=\"search_start_dt\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"wrap_carendar\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"search_end_dt\" name=\"search_end_dt\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn_search\" onclick=\"javascript:goSearch(); return false;\">검색</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>급여지급일</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>기본급</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>총지급액</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>공제합계</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>차인지급액</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr style=\"cursor:pointer;\" class=\"bg_d\" onclick=\"javascript:goSalary('");
      out.print(StringUtil.nvl(salaryVO.getPay_date()));
      out.write("'); return false;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.nvl(salaryVO.getPay_date()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(salaryVO.getPay_amt1()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(salaryVO.getPay_amt46()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(salaryVO.getPay_amt47()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(StringUtil.makeMoneyType(salaryVO.getPay_amt48()));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.print(StringUtil.makeMoneyType(salaryTotalCount));
      out.write("</span>건\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.write('\r');
