...
<head>
	...
	winResize = 1446 - winWidth;  //CHOE 20160113 화면이 1120보다 커지지 않는다.  1120
				...
				<div class="confirm">
					...
					<tbody>
							...
							<tr>
								...
								<input type="text" name="subject" id="subject" value="물품 구입 청구확인서"/>
								<% 	} else if("E01016".equals(docu_cd)){ %>
								<input type="text" name="subject" id="subject" value="원부자재 납품확인서"/>
								<%	} 
								}else {%>
								<input type="text" name="subject" id="subject" value="<%=RequestFilterUtil.toHtmlTagReplace("", approvalMasterVO.getSubject()) %>" />
								<%}%>
								</td> 
							</tr>
						</tbody>
