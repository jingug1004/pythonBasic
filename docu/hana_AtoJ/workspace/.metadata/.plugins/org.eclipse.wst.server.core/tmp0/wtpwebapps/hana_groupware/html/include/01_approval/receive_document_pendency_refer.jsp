...
<div class="wrap_statement_overtime">
	<div class="top">
		...
		<div>
			<button class="type2">미리보기</button>
			<div class="fr">
		...
		<div class="cont_box cont_table06">
			...
			<table>
				...
				<tbody>
					...
					<tr class="appr">
						<!-- 기결 처리될 시  td 에 on 클래스 추가-->
						<td class="on">아무개<br /><br /><button>기결</button></td>
						<!-- 기결 처리될 시  td 에 on 클래스 추가-->
						<td class="on">홍길동<br /><br /><button>기결</button></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
