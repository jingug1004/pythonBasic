...
public class DBInfoManageUtil {
	...
	private List<Map<String, Object>> getOracleUserList(DataSource dataSource) {
		...
		sql.append("SELECT ORAUSER USERNAME									");
		sql.append("	 , HANACOMM.HANACRYPT('D' ,ORAUSER_PASS) PASSWORD 	");
		sql.append("	 , USE_YN USEYN 									");
		sql.append("  FROM TB_ORAUSER_INFO									");
		...
		//return  (List<Map<String, Object>>)jdbcTemplate.queryForList(sql.toString());
	}
