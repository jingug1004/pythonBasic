...
public class TurnsdayJsonVO {
	...
	private List<TurnsdayVO> rows; // list
	private TurnsdayVO totalCountInfo; // 합계 정보
	 ...
	 * @return the rows
	 */
	public List<TurnsdayVO> getRows() {
		return rows;
	}
	/**
	 * @param rows the rows to set
	 */
	public void setRows(List<TurnsdayVO> rows) {
		this.rows = rows;
	}
	/**
	 * @return the totalCountInfo
	 */
	public TurnsdayVO getTotalCountInfo() {
		return totalCountInfo;
	}
	/**
	 * @param totalCountInfo the totalCountInfo to set
	 */
	public void setTotalCountInfo(TurnsdayVO totalCountInfo) {
