...
public class LoginUserDAOImpl extends SqlSessionDaoSupport implements LoginUserDAO{
	 ...
	 */
	@Override
	public LoginUserVO getLoginFirstChk(Map<String, String> paramMap){
		LoginUserVO loginUserVO = (LoginUserVO) getSqlSession().selectOne("member.getLoginChk", paramMap);

		if(null == loginUserVO){
			loginUserVO = (LoginUserVO) getSqlSession().selectOne("member.getLoginForEmployeeChk", paramMap);
		}
	...
	public LoginUserVO getLoginMng(Map<String, String> paramMap){
		LoginUserVO loginUserVO = (LoginUserVO) getSqlSession().selectOne("member.getLoginUserMng", paramMap);

		if(null == loginUserVO){
			loginUserVO = (LoginUserVO) getSqlSession().selectOne("member.getLoginForEmployeeMng", paramMap);
		}
