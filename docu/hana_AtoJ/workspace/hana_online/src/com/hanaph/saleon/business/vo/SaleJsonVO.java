...
public class SaleJsonVO {
	...
	private List<SaleVO> rows; // list
	private SaleVO totalCountInfo; // 합계 정보
	 ...
	 * @return the rows
	 */
	public List<SaleVO> getRows() {
		return rows;
	}
	/**
	 * @param rows the rows to set
	 */
	public void setRows(List<SaleVO> rows) {
		this.rows = rows;
	}
	/**
	 * @return the totalCountInfo
	 */
	public SaleVO getTotalCountInfo() {
		return totalCountInfo;
	}
	/**
	 * @param totalCountInfo the totalCountInfo to set
	 */
	public void setTotalCountInfo(SaleVO totalCountInfo) {
