...
public class ItemVO {
	...
	private String addrseq; // 배송지코드
	private String addrname; // 배송지명
	
	private String productdiv;
	private String pieceyn;
	private String threeavgck;
	
	HashMap<String,String> itemChk;
	 ...
	 * @return the itemChk
	 */
	public HashMap<String, String> getItemChk() {
		return itemChk;
	}
	/**
	 * @param itemChk the itemChk to set
	 */
	public void setItemChk(HashMap<String, String> itemChk) {
	...
	/**
	 * @param productdiv the productdiv to set
	 */
	public void setProductdiv(String productdiv) {
		this.productdiv = productdiv;
	}
	/**
	 * @return the pieceyn
	 */
	public String getPieceyn() {
		return pieceyn;
	}
	/**
	 * @param pieceyn the pieceyn to set
	 */
	public void setPieceyn(String pieceyn) {
		this.pieceyn = pieceyn;
	}
	/**
	 * @return the threeavgck
	 */
	public String getThreeavgck() {
		return threeavgck;
	}
	/**
	 * @param threeavgck the threeavgck to set
	 */
	public void setThreeavgck(String threeavgck) {
		this.threeavgck = threeavgck;
	}
