...
<head>
	...
	$(document).ready(function(){
		...
		$("#grid_list_client1").jqGrid({
			mtype:"get",
			datatype:"json",
			colNames:["고객코드","고객명","성별","생년월일","실제생일","결혼여부","결혼기념일","성향","종교","출신고교","출신대학","전화번호","핸드폰번호","팩스번호","메일주소","차량번호","차종/색상","해외연수여부","직위","전문과","자녀관계","수련병원","전공","주거래도매처","대인관계","취미","금기사항","우편번호","주소","상세주소","기타사항","히라코드"],
			colModel:[
						...
						{name:"hiracode",			index:"hiracode",			hidden:true}
					],
			height:109,
			rownumWidth : 30,
			page: 1,
...
//            $("<input></input>").attr({type:"hidden", name:"hiracode", value: $("#hiracode").val()}).appendTo(frm);
		...
		<div class="tab_all tab_customer01" id="tab_customer01">
			...
			<div class="re_style06 box_type01">
				<form id="personalInfoFrm" name="personalInfoFrm">
					...
					<input type="hidden" id="hiracode" name="hiracode"/>
