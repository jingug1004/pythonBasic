		...
		<div class="wrap_search">
			<div class="search">
				<div class="float_l">
					...
					<button type="button" class="btn_search" onclick="javascript:Commons.popupOpen('as_fr_cust', '<%=ONLINE_ROOT%>/business/common/customerList.do', '650', '655');" ><span class="blind">찾기</span></button>
