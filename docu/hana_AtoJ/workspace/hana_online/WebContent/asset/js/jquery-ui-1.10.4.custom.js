...
function Datepicker() {
	...
	this.regional = ["ko-KR"]; // Available regional settings, indexed by language code
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		yearRange: "1900:+2", // Range of years to display in drop-down,
