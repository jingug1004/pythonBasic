...
var Order = {
	...
	/**
	 * 배송지 조회 팝업창에서 배송지 선택하면 그 정보를 opener에게 전달하고 창닫기
	 */
    baesongjiValue : function() {
        ...
        if (id) {
            ...
            var targetCode = "addrseq";
            var targetName = "baesongji_name";
            
            try {
                $("#" + targetCode, opener.document).val(seq);
                $("#" + targetName, opener.document).val(addr1);
            } catch (e) {
            } finally {
                self.close();
            }
