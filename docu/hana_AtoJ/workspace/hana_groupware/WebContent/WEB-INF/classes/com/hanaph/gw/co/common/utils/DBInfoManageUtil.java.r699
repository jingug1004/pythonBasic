...
public class DBInfoManageUtil {
	...
	private List<Map<String, Object>> getOracleUserList(DataSource dataSource) {
		...
		return  (List<Map<String, Object>>)jdbcTemplate.queryForList("SELECT ORAUSER USERNAME, UTL_I18N.RAW_TO_CHAR(ORAUSER_PASS) PASSWORD, USE_YN USEYN FROM TB_ORAUSER_INFO WHERE ORAUSER = 'HANAGROUPWARE'");
	}
