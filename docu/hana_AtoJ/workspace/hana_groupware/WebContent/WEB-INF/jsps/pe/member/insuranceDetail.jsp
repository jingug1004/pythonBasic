					...
					<div class="wrap_list mt10">
						<div class="tableA">
							...
							<table>
								...
								<tr>
									<th>총 급여</th>
									<td colspan="3" class="txt_r"><%=StringUtil.cleanup(StringUtil.nvl(insuranceDetail.getT_pay())) %></td>
								<tr>	
									<th>근무개월</th>
									<td colspan="3" class="txt_r"><%=StringUtil.cleanup(StringUtil.nvl(insuranceDetail.getMonth())) %>개월</td>
								</tr>
								<tr>
									<th>보수월액</th>
									<td colspan="3" class="txt_r"><%=StringUtil.cleanup(StringUtil.nvl(insuranceDetail.getMonth_pay())) %></td>
								</tr> 
								<tr>
									<th>납부한 총 보험료</th>
									<td colspan="3" class="txt_r"><%=StringUtil.cleanup(StringUtil.nvl(insuranceDetail.getPayment_1())) %></td>									
								</tr> 
								<tr>
									<th>확정보험료</th>
									<td colspan="3" class="txt_r"><%=StringUtil.cleanup(StringUtil.nvl(insuranceDetail.getDecide_1())) %></td>									
								</tr> 
								<tr>
									<th>가입자부담금</th>
									<td colspan="3" class="txt_r"><%=StringUtil.cleanup(StringUtil.nvl(insuranceDetail.getBurden_1())) %></td>									
								</tr> 
								<tr>
