...
<h5>
	...
	<span class="w_date3">거래처 : <%=StringUtil.nvl(deliveryDetailList.get(0).getCust_id()) %></span>	
</h5>
<div class="confirm">
	<table class="over">
		<colgroup>			
		...
		<tbody>
			...
			<tr class="in_table">	
				...
				<%if (i == 0){ %>				
				<td class="txtright"><%=StringUtil.nvl(deliVO.getAmt_sum()) %></td>
				<td class="txtright"><%=StringUtil.nvl(deliVO.getVat_sum()) %></td>
				<td class="txtright"><%=StringUtil.nvl(deliVO.getTot_sum()) %></td>
				<%} %>
