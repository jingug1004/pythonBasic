	...
	<table class="over">
		...
		<tbody>			
			<tr class="in_table">
				...
				<td class="br_none"><input type="hidden" name="warehousingno" id="warehousingno0" value=""/></td>													
			</tr>
		</tbody>						
				<%
						}
		...
		<tbody>
			<tr>
				...
				<td class="br_none"><%= StringUtil.nvl(deliVO.getBigo()) %>
					...
					<input type="hidden" name="warehousingno" id="warehousingno<%=i%>" value="<%= StringUtil.nvl(deliVO.getBigo()) %>"/>
				</td>										
			</tr>
		</tbody>					
					<%	
