...
<%--
 * @파일명 : step2approvalMemberIframe.jsp
 * @메뉴명 : 결재라인 회원정보 리스트 ifrmae
 * @최초작성일 : 2015/01/28            
 * @author : CHOIILJI                 
 * @수정내역 : 
--%>
...
<body>
	<div class="search_box02">
		<form name="frm" id="frm" method="post" action="<%=GROUP_ROOT %>/ea/newReport/step2approvalMemberIframe.do"> 
		<span>사원명</span>
		<input type="text" name="emp_ko_nm" id="emp_ko_nm" value="<%=emp_ko_nm%>"  class="w210" onKeyPress="if(event.keyCode=='13'){goSearch(); return false;}"/>
