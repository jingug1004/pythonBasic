...
<%--
 * @파일명 : personApprovalDeptTargetIframe.jsp
 * @메뉴명 : 개인결재라인 시행부서 대상 iframe
 * @최초작성일 : 2015/01/28            
 * @author : CHOIILJI                 
 * @수정내역 : 
--%>
...
<%
	//시행
	List<PersonImplDeptVO> personImplDeptDetailList = (List<PersonImplDeptVO>)request.getAttribute("personImplDeptDetailList");
%>
<!DOCTYPE html>
<html lang="ko">
<head>
