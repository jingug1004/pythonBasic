...
//	int cnt = receiveService.getReceiveCount(paramMap);	//내가받은문서 카운트
	int mainMustOpinionReportCnt = ((Integer)request.getAttribute("mainMustOpinionReportCnt")).intValue(); //내가올린문서 리스트 카운트
	int mainMustOpinionReceiveCnt = ((Integer)request.getAttribute("mainMustOpinionReceiveCnt")).intValue(); //내가받은문서 리스트 카운트
								...
								<div class="tableB cont_table06 table_width03">
									<table>
										...
										<tbody>
											...
											%>
											<tr>
												<th class="bt_none">올린 '시행부서 의견 필수'</th>
												<td class="bt_none">
													<%--<a href="#" onclick="location.href='<%=GROUP_ROOT%>/ea/report/reportList.do?search_docu_state=<%=approvalMasterVO.getState()%>'">--%>
													<a href="#" onclick="location.href='<%=GROUP_ROOT%>/ea/report/reportList.do?checkMustOpinion=Y'">
														<%=StringUtil.makeMoneyType(mainMustOpinionReportCnt)%>건
													</a>
												</td>
											</tr>
										</tbody>
								...
								<div class="tableB cont_table06 table_width03">
									<table>
										...
										<tbody>
											...
											%>
											<tr>
												<th class="bt_none">받은 '시행부서 의견 필수'</th>
												<td class="bt_none">
													<%--<a href="#" onclick="location.href='<%=GROUP_ROOT%>/ea/report/reportList.do?search_docu_state=<%=approvalMasterVO.getState()%>'">--%>
													<a href="#" onclick="location.href='<%=GROUP_ROOT%>/ea/receive/receiveList.do?checkMustOpinion=Y'">
														<%=StringUtil.makeMoneyType(mainMustOpinionReceiveCnt)%>건
													</a>
												</td>
											</tr>
										</tbody>
