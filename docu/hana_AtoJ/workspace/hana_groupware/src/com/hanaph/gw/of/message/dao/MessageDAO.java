...
public interface MessageDAO {
	...
	/**
	 * <pre>
	 * 1. 개요     : 시행부서 의견 필수 사원 리스트 쪽지 보내기
	 * 2. 처리내용 : 시행부서 의견 필수 사원 리스트 쪽지 보낼 대상자를 저장한다.
	 * ml180122.ml20_T59 김진국 - messageDAO.java에 insertMessageTarget 인터페이스 추가 - 시행부서 의견 필수 시 쪽지 보낼 리스트 사원 추가
	 * </pre>
	 * @Method Name : insertMessageTargetMustOpinion
	 * @param messageVO
	 * @return
	 */
	void insertMessageTargetMustOpinion(MessageVO messageVO);
	...
	/**
	 * <pre>
	 * 1. 개요     : 시행부서 의견 필수 쪽지 보내기
	 * 2. 처리내용 : 시행부서 의견 필수  쪽지를 보낸다.
	 * ml180122.ml15_T54 김진국 - MessageDAO.java에 insertMessageMustOpinion(messageVO) 구현 메서드 추가 - 시행부서 의견 필수 시 쪽지 추가
	 * </pre>
	 * @Method Name : insertMessage
	 * @param messageVO
	 * @return
	 */
	void insertMessageMustOpinion(MessageVO messageVO);
