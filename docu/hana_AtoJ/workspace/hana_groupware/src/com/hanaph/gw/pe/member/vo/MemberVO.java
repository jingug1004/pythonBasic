...
public class MemberVO {
	...
	/* ml180125.ml03_T80 김진국 - MemberVO.java에 전 쪽지 수보다 현 쪽지수가 더 많으면 팝업 알림 beforeMessageReceiveCount 겟터 셋터 추가 - '시의필' 실행하면 실시간으로 쪽지수가 증가되어 확인 바라는 알림창 띄우기 위해서! */
	private int beforeMessageReceiveCount;// 로딩 전 받은쪽지카운트
	...
	public int getBeforeMessageReceiveCount() {
		return beforeMessageReceiveCount;
	}

	public void setBeforeMessageReceiveCount(int beforeMessageReceiveCount) {
		this.beforeMessageReceiveCount = beforeMessageReceiveCount;
	}
