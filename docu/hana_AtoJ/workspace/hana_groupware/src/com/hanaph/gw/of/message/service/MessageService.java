...
public interface MessageService {
	 ...
	 * 1. 개요     : 쪽지 전달
	 * 2. 처리내용 : 쪽지 대상자를 추가한다.
	 * ml180122.ml18_T57 김진국 - messageService.java에 insertMessageTarget 인터페이스 추가 - 시행부서 의견 필수 시 쪽지 보낼 리스트 사원 추가
	 * </pre>
	 * @Method Name : insertMessageTarget
	 * @param messageVO
	 */
	...
	/**
	 * <pre>
	 * 1. 개요     : 시행부서 의견 필수 시 쪽지 추가
	 * 2. 처리내용 : 시행부서 의견 필수 시 쪽지 insert 추가한다.
	 * ml180122.ml13_T52 김진국 - messageService.java에 messageService.insertMessageMustOpinion(messageVO) 인터페이스 추가 - 시행부서 의견 필수 시 쪽지 추가
	 * </pre>
	 * @Method Name : insertMessageMustOpinion
	 * @return
	 */
