...
/**
 * <pre>
 * Class Name : NewReportE01015DAO.java
 * 설명 : 기안서 
 * 
 ...
 * @since   : 2015. 12. 11.
 */
public interface NewReportE01015DAO {

	/**
	 * <pre>
	 * 1. 개요     : 물품 구입 청구서 등록을 한다. 
	 * 2. 처리내용 : 물품 구입 청구서 등록을 한다.
	 * </pre>
	...
	/**
	 * <pre>
	 * 1. 개요     : 물품 구입 청구서 상세정보를 가져온다. 
	 * 2. 처리내용 : 물품 구입 청구서 상세정보를 가져온다.
	 * </pre>
	 * @Method Name : requisitionDetail
	 * @param approval_seq
	 * @return
	 */
	...
	/**
	 * <pre>
	 * 1. 개요     : 물품 구입 청구서 수정을 한다.
	 * 2. 처리내용 : 물품 구입 청구서 수정을 한다.
	 * </pre>
