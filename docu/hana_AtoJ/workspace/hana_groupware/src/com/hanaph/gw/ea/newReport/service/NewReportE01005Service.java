...
/**
 * <pre>
 * Class Name : NewReportE01005Service.java
 * 설명 : 근태계
 * 
 ...
 * @since   : 2015. 1. 16.
 */
public interface NewReportE01005Service {
	 ...
	 * @return
	 */
	String insertCommute(ApprovalMasterVO paramAmVO, CommuteVO paramCmVO);
	 ...
	 * 2. 처리내용 : 근태계 수정
	 * </pre>
	 * @Method Name : updateCommute
	 * @param paramAmVO
	 * @param paramCmVO
	 */
	void updateCommute(ApprovalMasterVO paramAmVO, CommuteVO paramCmVO);
