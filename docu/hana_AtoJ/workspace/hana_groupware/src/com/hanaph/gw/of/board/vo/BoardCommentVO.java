...
public class BoardCommentVO extends CommonVO {
	...
	private int comment_seq;				//코멘트 시퀀스
	private int seq;						//글번호 시퀀스
	private String comments;				//코멘트 내용
	private String emp_no;					//작성자
	private List<BoardCommentVO> list;		//코멘트 리스트
	 ...
	 * @return the list
	 */
	public List<BoardCommentVO> getList() {
		return list;
	}
	/**
	 * @param list the list to set
	 */
	public void setList(List<BoardCommentVO> list) {
		this.list = list;
	}
	/**
