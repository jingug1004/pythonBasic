 ...
 * 설명 : com.hanaph.gw.common.utils.Environment.java 환경변수 가져오는 Class
 * 
	...
	public Environment() {
		...
		try {
			...
			if(System.getProperty("server.type") != null && !System.getProperty("server.type").isEmpty()){
				propPath = "/com/hanaph/gw/properties/config_"+System.getProperty("server.type")+".properties";
				dbPropPath = "/com/hanaph/gw/properties/database_"+System.getProperty("server.type")+".properties";
			} else {
				propPath = "/com/hanaph/gw/properties/config_local.properties";
				dbPropPath = "/com/hanaph/gw/properties/database_local.properties";
			}
