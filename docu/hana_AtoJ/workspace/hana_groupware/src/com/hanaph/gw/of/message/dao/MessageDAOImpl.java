...
public class MessageDAOImpl extends SqlSessionDaoSupport implements MessageDAO{
	...
	/**
	 * ml180122.ml21_T60 김진국 - messageDAOImpl.java에 insertMessageTarget 구현 메서드 추가 - 시행부서 의견 필수 시 쪽지 보낼 리스트 사원 추가
	 * @param messageVO
	 */
	public void insertMessageTargetMustOpinion (MessageVO messageVO) {
		getSqlSession().insert("message.insertMessageTarget", messageVO);
	}
	...
	public void insertMessageMustOpinion(MessageVO messageVO) {
		...
		getSqlSession().insert("message.insertMessageMustOpinion", messageVO);
