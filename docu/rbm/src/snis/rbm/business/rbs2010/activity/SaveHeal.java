/*================================================================================
 * 시스템			: 건전레저사업
 * 소스파일 이름	: snis.rbm.business.rbs2010.activity.SaveHeal.java
 * 파일설명		: 건전레저사업 등록
 * 작성자			: 이승배
 * 버전			: 1.0.0
 * 생성일자		: 2011-09-2
...
public class SaveHeal extends SnisActivity {
	    ...
	    */
	    ...
	    {			           
	        ...
	        int i = 0;
	        param.setValueParamter(i++, record.getAttribute("HEAL_YEAR"));       // 1.년도
	        ...
	        param.setValueParamter(i++, record.getAttribute("BUSI_STAT_CD"));    // 8. 사업상태코드 		                
	    ...
	    {			
	        ...
	        i = 0;
	        param.setWhereClauseParameter(i++, record.getAttribute("BUSI_CNTNT_CD"));   // 8. 평가년도
