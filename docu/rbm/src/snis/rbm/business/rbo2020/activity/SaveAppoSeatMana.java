package snis.rbm.business.rbo2020.activity;
...
public class SaveAppoSeatMana extends SnisActivity {
    ...
    */
    ...
    protected int insertAppoSeatMana(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rbo2020_i01", param);
    ...
    protected int updateAppoSeatMana(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rbo2020_u01", param);
        return dmlcount;
    }
    ...
    protected int updateAppoSeat(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rbo2020_u03", param);
        return dmlcount;
    }
    ...
    protected int deleteAppoSeatMana(PosRecord record) 
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rbo2020_d01", param);
    ...
    protected String getMaxSalesNo(PosRecord record) 
    {
        ...
        PosRowSet keyRecord = this.getDao("rbmdao").find("rbo2020_s04",param);        
    ...
    protected int updateSeatCd(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("rbmdao").update("rbo2020_u04", param);
        return dmlcount;
    }
}
