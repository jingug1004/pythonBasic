/*================================================================================
 * 시스템		: 선수관리
 * 소스파일 이름: snis.boa.racer.e03040010.activity.SaveEquipmentConfirm.java
 * 파일설명		: 모터/보트배정 확정
 * 작성자			: 김경화
 * 버전			: 1.0.0
 * 생성일자		: 2008-02-26
...
* @version 1.0
*/
public class SaveEquipmentConfirm extends SnisActivity
{    
	private String sStndYear = "";
	private String sMbrCd    = "";
	private String sTms      = "";
	
    public SaveEquipmentConfirm()
    {
    }
    ...
    protected int updateRaceTms(PosContext ctx) 
    {
        ...
        sStatCd = sp.getEquipDrwltCmplYn(sStndYear, sMbrCd, sTms);
		...
		if(!"Y".equals(sStatCd)){
    		try { 
        		...
        		Util.setSvcMsg(ctx, "추첨대상등록이 완료되지 않았습니다!!!");
        		return 0;        		
        	}			
		}
