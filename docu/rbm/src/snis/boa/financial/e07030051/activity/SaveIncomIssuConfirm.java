...
* @version 1.0
*/
public class SaveIncomIssuConfirm extends SnisActivity
{    
    public SaveIncomIssuConfirm()
    {
    }
    ...
    */
    protected void saveState(PosContext ctx) 
    {
        ...
        for ( int i = 0; i < nSize; i++ ){
            PosRecord record = ds.getRecord(i);
           	nSaveCount = nSaveCount + saveIncomIssuConfirm(record);
        }
     ...
     * @throws  none
     */
    protected int saveIncomIssuConfirm(PosRecord record)
    {
    	int effectedRowCnt = updateIncomIssuConfirm(record);
     ...
     * @throws  none
     */
    protected int updateIncomIssuConfirm(PosRecord record)
    {
        ...
        return this.getDao("boadao").update("tbeg_incom_issu_uf001", param);
    }
