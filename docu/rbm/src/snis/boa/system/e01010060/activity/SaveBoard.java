 ...
 * 최종수정내용	: 
=================================================================================*/
package snis.boa.system.e01010060.activity;
...
{    
    ...
    */
    ...
    protected int updateBoard(PosRecord record)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbea_bord_ua002", param);
    ...
    protected int insertBoard(PosRecord record) 
    {
        ...
        param.setValueParamter(i++, SESSION_USER_ID);
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("boadao").update("tbea_bord_ia001", param);
    ...
    protected int replyBoard(PosRecord record, PosContext ctx) 
    {
        ...
        param.setValueParamter(i++, SESSION_USER_ID);
        param.setValueParamter(i++, SESSION_USER_ID);
        int dmlcount = this.getDao("boadao").update("tbea_bord_ra001", param);
    ...
    protected void updateGrpLowNo(String grpNo, int grpLowNo) 
    {
        ...
        this.getDao("boadao").update("tbea_bord_ia002", param);
    }
    ...
    protected int deleteBoard(PosContext ctx)
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbea_bord_da001", param);
        return dmlcount;
    }
    ...
    protected int insertFile(PosRecord record, PosContext ctx) 
    {
        ...
        int i = 0;
        param.setValueParamter(i++, ctx   .get         ("CLS_CD") );
        ...
        int dmlcount = this.getDao("boadao").update("tbea_bord_ia003", param);
    ...
    protected int insertFileWithSeq(PosRecord record, PosContext ctx) 
    {
        ...
        int i = 0;
        param.setValueParamter(i++, record.getAttribute("CLS_CD") );
        ...
        int dmlcount = this.getDao("boadao").update("tbea_bord_ia004", param);
    ...
    protected int deleteFile(PosRecord record,  PosContext ctx) 
    {
        ...
        int dmlcount = this.getDao("boadao").update("tbea_bord_da002", param);
