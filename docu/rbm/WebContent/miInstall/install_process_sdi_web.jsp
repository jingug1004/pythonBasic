...
<%  	
    String installUrl	= "http://localhost:8080/rbm/miInstall";
    String webAppUrl	= "http://localhost:8080/rbm/rbm_ui/rbm_ci_main_sdi.xml";
    String keyValue		= "RBM_WEB";    
...
<SCRIPT LANGUAGE="JavaScript"
	src="http://localhost:8080/rbm/script/MiInstaller320.js"></SCRIPT>
<style>
.f2 {
	font-size: 12
}
...
<script language="javascript">
	...
	function fn_run()
	{
		...
		window.opener = self; 
		window.location.href = "./sdi_main.jsp"; 
		//self.close();  
	}	
//	
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table class="hide" id=reinstall>
					...
					<tr>
						<td><a class="f2"
							href="./320U/MiPlatform_SetupUpdater321_20090105_0920.exe">수동설치</a></td>
					</tr>
				</table>
				</td>
			</tr>
