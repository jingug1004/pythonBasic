...
<head>
	...
	<style type="text/css">
		* {margin:0; padding:0}
		...
		.title01  {width:98%;float:left;  height: 50px; margin-left:15px;  border:0px solid red}
		...
		.grp01  {width:49%; float:left;  padding-top:10px; font-size:16px; border:0px solid blue;}
		.grp02  {width:49%; float:right; padding-top:10px; font-size:16px; border:0px solid blue;}
		...
		.col01  {width:98%; float:left;  height: 270px; margin-left:15px;  border:0px solid blue}
		.col03  {width:98%; float:left;  height: 150px; margin-left:15px;  border:0px solid blue}
