...
<head>
	...
	<style type="text/css">
		* {margin:0; padding:0}
		...
		#title_1 {width:500px;  height: 25px; background-image:url(image/kspo_s_title_1.gif); background-repeat: no-repeat; font-weight:bold; border:1px solid blue;}
		.title01  {width:48%; float:left;  height: 50px; margin-left:15px;  border:0px solid red}
		.title02  {width:48%; float:right; height: 50px; margin-right:15px; border:0px solid red}		
		...
		.row01  {padding-top:30px; background-image:url("image/bg_top_title.gif"); font-size:16px; font-size:16px; border:0px solid blue;}
		.row02  {padding-top:10px; font-size:16px; font-size:14px; border:0px solid red;}
		.row03  {padding-top:0px; font-size:16px; font-size:16px; border:0px solid cyan;}
		.row04  {padding-top:25px; font-size:16px; font-size:16px; border:0px solid brown;}
		.col01  {width:48%; float:left;  height: 270px; margin-left:15px;  border:0px solid red}
		.col02  {width:48%; float:right; height: 270px; margin-right:15px; border:0px solid red}		
		.col03  {width:48%; float:left;  height: 150px; margin-left:15px;  border:0px solid red}
		.col04  {width:48%; float:right; height: 150px; margin-right:15px; border:0px solid red}		
		.col05  {width:48%; float:left;  height: 230px; margin-left:15px;  border:0px solid red}
	...
	<script type="text/javascript">
	  ...
	  function drawChart() {
	    ...
	    var data10 = google.visualization.arrayToDataTable([
	      ['지점', '<%=getData(rVect04,0,"PREV_TMS")%>', '<%=getData(rVect04,0,"CUR_TMS")%>']	      
		<%
		if(rVect04 != null) {
			if (cnt04>0) {
		...
		%>
		    ,['<%=getData(rVect04,i,"COMM_NM")%>',<%=getData(rVect04,i,"PREV_TMS_AMT")%>,<%=getData(rVect04,i,"CUR_TMS_AMT")%>]
		<%
						}
					}
				}
	    ...
	    chart10.draw(data10, options_jijum_kcycle);
	    
		<!-- 경정 지점 매출 -->
	    var data13 = google.visualization.arrayToDataTable([
	      ['지점', '<%=getData(rVect04,cnt04 -1,"PREV_TMS")%>', '<%=getData(rVect04,cnt04 -1,"CUR_TMS")%>']	      
		<%
		if(rVect04 != null) {
			if (cnt04>0) {
				for(int i=0; i<cnt04; i++) {	
	    ...
	    var chart13 = new google.visualization.ColumnChart(document.getElementById('chart_div13'));
	    chart13.draw(data13, options_jijum_kboat);	    
...
<body style="font-family:'굴림', 'Gulim'">
	...
	<div class="row01">
		<div class="title01" style="color:#454545;">
			<table width="100%"><tr><td width="150"><img src="image/top_logo_kcycle.gif" alt="LOGO KCYCLE"></td>
			           <td><img src="image/top_title_kcycle.gif" alt="KCYCLE"></td></tr>
			       <tr><td colspan="2" class="titlebar_kcycle" height="5"></td></tr>
			       </table>    
		</div>
		<div class="title02" style="text-align;">
			<table width="100%"><tr><td width="136"><img src="image/top_logo_kboat.gif" alt="LOGO KBOAT"></td>
			           <td><img src="image/top_title_kboat.gif" alt="KBOAT"></td></tr>
			       <tr><td colspan="2" class="titlebar_kboat" height="5"></td></tr>
			       </table>    
		</div>
	...
	<div class="row02" >
		<div class="col01" style="color:#454545;">
			...
			<div id="chart_div"  style="width: '100%'; height: 200px; border:0px solid blue"></div>
		</div>
		<div class="col02" style="color:#454545;">
	...
	<div class="row04" >
		<div class="col05" style="color:#454545;">
			<table width="100%"><tr><td width="10" height="37" align="left"><img src="image/bg_title_kcycle.gif" alt="KCYCLE BAR"></td>
		...
		<div class="col06" style="color:#454545;">
			<table width="100%"><tr><td width="10" height="37" align="left"><img src="image/bg_title_kboat.gif" alt="KCYCLE BAR"></td>
			           <td><img src="image/title3.gif" alt="|지점별 매출비교"></td></tr>
			       <tr><td colspan="2" class="titlebar_chart_kboat" height="5"></td></tr>
 	        </table>
