...
console.warn('VUX :이 행이 표시되면 vux-loader 구성에 문제가 있거나 주문형 구성 요소로 구문 분석 할 수없는 코드 작성 사양의 이유로 인해 패키징 볼륨이 너무 커질 수 있음을 의미합니다. 최신 vux 로더로 업그레이드하십시오. eslint(standard)。')
