...
export const loadSeckillsInfo = ({ commit }) => {
  return new Promise((resolve, reject) => {
    const data = [
      {
        intro: '[선물 팬] 비타 레몬 차 250ml * 32 상자 선물 포장 FCL',
        img: 'static/img/index/seckill/seckill-item1.jpg',
        price: 71.9,
        realPrice: 89.6
      },
      {
        intro: 'Kindle Paperwhite 6 인치 눈 보호 비 반사 전자 잉크의 새로운 업그레이드 버전',
        img: 'static/img/index/seckill/seckill-item2.jpg',
        price: 989.0,
        realPrice: 1299.0
      },
      {
        intro: '왕위, 형제, 찹쌀, 캐서롤 먹어라. 안후이 명물 찹쌀 원래 맛 400g * 2 상자',
        img: 'static/img/index/seckill/seckill-item3.jpg',
        price: 21.8,
        realPrice: 49.0
      },
      {
        intro: '[징동 슈퍼마켓] 브리즈 (APP) 종이 프롤로그 퓨어 골드 시리즈 3',
        img: 'static/img/index/seckill/seckill-item4.jpg',
        price: 49.9,
        realPrice: 59.0
      },
      {
        intro: 'NIKE 나이키 남성 캐주얼 신발 AIR MAX 90 ESSENTIAL 에어 쿠션',
...
export const loadComputer = ({ commit }) => {
  return new Promise((resolve, reject) => {
    const computer = {
      title: '컴퓨터 디지털',
      link: [ '컴퓨터 홀', '최고의 게임', '설치 프로그램', '작업장 회춘', '여신 채널', '가상 현실', '2 대 1 태블릿', '전자 교육', 'Everything Weekly' ],
      detail: [
        {
...
export const loadEat = ({ commit }) => {
  return new Promise((resolve, reject) => {
    const eat = {
      title: '먹는 것을 좋아합니다.',
      link: [ '캐주얼 스낵', '너트', '우유', '음료', '식용유', '쌀', '술', '레드 와인', '바베큐 재료', '스테이크', '체리' ],
      detail: [
        {
